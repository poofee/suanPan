...
namespace flow {
    namespace interface10 {
        ...
        namespace internal {
            ...
            template <typename T, typename = void> struct async_helpers {
                typedef async_msg<T> async_type;
                typedef T filtered_type;

                static const bool is_async_type = false;

                static const void* to_void_ptr(const T& t) { return static_cast<const void*>(&t); }

                static void* to_void_ptr(T& t) { return static_cast<void*>(&t); }

                static const T& from_void_ptr(const void* p) { return *static_cast<const T*>(p); }
            ...
            template <typename T> struct async_helpers<T, typename std::enable_if<std::is_base_of<async_msg<typename T::async_msg_data_type>, T>::value>::type> {
                ...
                static const void* to_void_ptr(const T& t) { return static_cast<const void*>(&static_cast<const async_msg<filtered_type>&>(t)); }

                static void* to_void_ptr(T& t) { return static_cast<void*>(&static_cast<async_msg<filtered_type>&>(t)); }

                // Sender-classes use non-const interfaces
                static const T& from_void_ptr(const void* p) { return *static_cast<const T*>(static_cast<const async_msg<filtered_type>*>(p)); }

                static T& from_void_ptr(void* p) { return *static_cast<T*>(static_cast<async_msg<filtered_type>*>(p)); }
            ...
            protected:
                ...
                template <typename X> bool try_get(X& t) { return try_get_wrapper(internal::async_helpers<X>::to_void_ptr(t), internal::async_helpers<X>::is_async_type); }

                //! Reserves an item in the sender
                template <typename X> bool try_reserve(X& t) { return try_reserve_wrapper(internal::async_helpers<X>::to_void_ptr(t), internal::async_helpers<X>::is_async_type); }
            ...
            public:
                ...
                template <typename X> bool try_put(const X& t) {
...
#endif
            protected:
                template <typename X> task* try_put_task(const X& t) { return try_put_task_wrapper(internal::async_helpers<X>::to_void_ptr(t), internal::async_helpers<X>::is_async_type); }
        ...
        template <typename T> class sender : public internal::untyped_sender {
        public:
        ...
        protected:
            virtual bool try_get_wrapper(void* p, bool is_async) __TBB_override {
                ...
                if(internal::async_helpers<T>::is_async_type == is_async) { return try_get(internal::async_helpers<T>::from_void_ptr(p)); }
            ...
            virtual bool try_reserve_wrapper(void* p, bool is_async) __TBB_override {
                // Both async OR both are NOT async
                if(internal::async_helpers<T>::is_async_type == is_async) { return try_reserve(internal::async_helpers<T>::from_void_ptr(p)); }
                // Else: this (T) is async OR incoming 't' is async
        ...
        template <typename T> class receiver : public internal::untyped_receiver {
        ...
        public:
            ...
            //! Put an item to the receiver
            bool try_put(const typename internal::async_helpers<T>::filtered_type& t) { return internal::untyped_receiver::try_put(t); }

            bool try_put(const typename internal::async_helpers<T>::async_type& t) { return internal::untyped_receiver::try_put(t); }

        protected:
            virtual task* try_put_task_wrapper(const void* p, bool is_async) __TBB_override { return internal::async_helpers<T>::try_put_task_wrapper_impl(this, p, is_async); }
    ...
    template <typename K, typename T> K key_from_message(const T& t) { return t.key(); }
...
#include "internal/_flow_graph_async_msg_impl.h"
        ...
        template <typename C, typename N> void graph_iterator<C, N>::internal_forward() {
        ...
        inline void graph::reset(reset_flags f) {
            ...
            for(task_list_type::iterator rti = my_reset_task_list.begin(); rti != my_reset_task_list.end(); ++rti) { my_task_arena->execute(graph::spawn_functor(*(*rti))); }
        ...
        inline void graph::set_name(const char* name) { tbb::internal::fgt_graph_desc(this, name); }
#endif
...
#include "internal/_flow_graph_node_impl.h"
        ...
        public:
            ...
            source_node(graph& g, Body body, bool is_active = true)
                ...
                tbb::internal::fgt_node_with_body(tbb::internal::FLOW_SOURCE_NODE, &this->my_graph, static_cast<sender<output_type>*>(this), this->my_body);
            }
...
#if TBB_PREVIEW_FLOW_GRAPH_TRACE
            void set_name(const char* name) __TBB_override { tbb::internal::fgt_node_desc(this, name); }
#endif
        ...
        private:
            ...
            task* create_put_task() { return (new(task::allocate_additional_child_of(*(this->my_graph.root_task()))) internal::source_task_bypass<source_node<output_type>>(*this)); }

            //! Spawns a task that applies the body
            void spawn_put() {
                if(internal::is_graph_active(this->my_graph)) { internal::spawn_in_graph_arena(this->my_graph, *create_put_task()); }
            }
        ...
        template <typename T> struct allocate_buffer { static const bool value = false; };

        template <> struct allocate_buffer<queueing> { static const bool value = true; };

        //! Implements a function node that supports Input -> Output
        template <typename Input, typename Output = continue_msg, typename Policy = queueing, typename Allocator = cache_aligned_allocator<Input>> class function_node : public graph_node, public internal::function_input<Input, Output, Allocator>, public internal::function_output<Output> {
        public:
            ...
            function_node(graph& g, size_t concurrency, Body body)
                : graph_node(g)
                , fInput_type(g, concurrency, body, allocate_buffer<Policy>::value ? new input_queue_type() : NULL) {
                tbb::internal::fgt_node_with_body(tbb::internal::FLOW_FUNCTION_NODE, &this->my_graph, static_cast<receiver<input_type>*>(this), static_cast<sender<output_type>*>(this), this->my_body);
            }
        ...
        class multifunction_node : public graph_node,
                                   public internal::multifunction_input<Input,
                                       typename internal::wrap_tuple_elements<tbb::flow::tuple_size<Output>::value, // #elements in tuple
        ...
        public:
            ...
            multifunction_node(graph& g, size_t concurrency, Body body)
                : graph_node(g)
                , base_type(g, concurrency, body, allocate_buffer<Policy>::value ? new input_queue_type : NULL) {
                tbb::internal::fgt_multioutput_node_with_body<N>(tbb::internal::FLOW_MULTIFUNCTION_NODE, &this->my_graph, static_cast<receiver<input_type>*>(this), this->output_ports(), this->my_body);
            }

            multifunction_node(const multifunction_node& other)
                : graph_node(other.my_graph)
                , base_type(other, allocate_buffer<Policy>::value ? new input_queue_type : NULL) {
                tbb::internal::fgt_multioutput_node_with_body<N>(tbb::internal::FLOW_MULTIFUNCTION_NODE, &this->my_graph, static_cast<receiver<input_type>*>(this), this->output_ports(), this->my_body);
            }

#if TBB_PREVIEW_FLOW_GRAPH_TRACE
            void set_name(const char* name) __TBB_override { tbb::internal::fgt_multioutput_node_desc(this, name); }
#endif
        ...
        public:
            ...
            typedef typename internal::wrap_tuple_elements<N, // #elements in tuple
                internal::multifunction_output,               // wrap this around each element
            ...
            explicit split_node(graph& g)
                : graph_node(g) {
                tbb::internal::fgt_multioutput_node<N>(tbb::internal::FLOW_SPLIT_NODE, &this->my_graph, static_cast<receiver<input_type>*>(this), this->output_ports());
            }
        ...
        template <typename Output> class continue_node : public graph_node, public internal::continue_input<Output>, public internal::function_output<Output> {
        public:
            typedef continue_msg input_type;
            typedef Output output_type;
            ...
            continue_node(graph& g, Body body)
                ...
                tbb::internal::fgt_node_with_body(tbb::internal::FLOW_CONTINUE_NODE, &this->my_graph, static_cast<receiver<input_type>*>(this), static_cast<sender<output_type>*>(this), this->my_body);
            }
        ...
        public:
            ...
            explicit overwrite_node(graph& g)
                ...
                my_successors.set_owner(this);
                tbb::internal::fgt_node(tbb::internal::FLOW_OVERWRITE_NODE, &this->my_graph, static_cast<receiver<input_type>*>(this), static_cast<sender<output_type>*>(this));
            }
            ...
            bool register_successor(successor_type& s) __TBB_override {
                ...
                if(my_buffer_is_valid && internal::is_graph_active(my_graph)) {
                    ...
                    if(ret) {
                        ...
                        task* rtask = new(task::allocate_additional_child_of(*(my_graph.root_task()))) register_predecessor_task(*this, s);
        ...
        public:
            ...
            explicit write_once_node(graph& g)
                : base_type(g) {
                tbb::internal::fgt_node(tbb::internal::FLOW_WRITE_ONCE_NODE, &(this->my_graph), static_cast<receiver<input_type>*>(this), static_cast<sender<output_type>*>(this));
            }
        ...
        public:
            explicit broadcast_node(graph& g)
                : graph_node(g) {
                my_successors.set_owner(this);
                tbb::internal::fgt_node(tbb::internal::FLOW_BROADCAST_NODE, &this->my_graph, static_cast<receiver<input_type>*>(this), static_cast<sender<output_type>*>(this));
            }
            ...
            void internal_add_built_successor(successor_type& r) __TBB_override { my_successors.internal_add_built_successor(r); }

            void internal_delete_built_successor(successor_type& r) __TBB_override { my_successors.internal_delete_built_successor(r); }

            size_t successor_count() __TBB_override { return my_successors.successor_count(); }

            void copy_successors(successor_list_type& v) __TBB_override { my_successors.copy_successors(v); }
            ...
            template <typename derived_type> void handle_operations_impl(buffer_operation* op_list, derived_type* derived) {
                ...
                if(try_forwarding && !forwarder_busy) {
                    if(internal::is_graph_active(this->my_graph)) {
                        forwarder_busy = true;
                        task* new_task = new(task::allocate_additional_child_of(*(this->my_graph.root_task()))) internal::forward_task_bypass<buffer_node<input_type, A>>(*this);
        ...
        public:
            ...
            explicit buffer_node(graph& g)
                ...
                tbb::internal::fgt_node(tbb::internal::FLOW_BUFFER_NODE, &this->my_graph, static_cast<receiver<input_type>*>(this), static_cast<sender<output_type>*>(this));
            }
        ...
        public:
            ...
            explicit queue_node(graph& g)
                : base_type(g) {
                tbb::internal::fgt_node(tbb::internal::FLOW_QUEUE_NODE, &(this->my_graph), static_cast<receiver<input_type>*>(this), static_cast<sender<output_type>*>(this));
            }
        ...
        public:
            ...
            sequencer_node(graph& g, const Sequencer& s)
                ...
                tbb::internal::fgt_node(tbb::internal::FLOW_SEQUENCER_NODE, &(this->my_graph), static_cast<receiver<input_type>*>(this), static_cast<sender<output_type>*>(this));
            }
        ...
        public:
            ...
            explicit priority_queue_node(graph& g)
                : buffer_node<T, A>(g)
                , mark(0) {
                tbb::internal::fgt_node(tbb::internal::FLOW_PRIORITY_QUEUE_NODE, &(this->my_graph), static_cast<receiver<input_type>*>(this), static_cast<sender<output_type>*>(this));
            }
        ...
        private:
            ...
            void reheap() {
                ...
                while(child < mark) {
                    ...
                    if(child + 1 < mark && compare(this->get_my_item(child), this->get_my_item(child + 1))) ++target;
                    // target now has the higher priority child
                    if(compare(this->get_my_item(target), this->get_my_item(cur_pos))) break;
                    // swap
                    ...
                    if((rval = my_successors.try_put_task(v)) != NULL) {
                        {
                            ...
                            if(check_conditions()) {
                                if(internal::is_graph_active(this->my_graph)) {
                                    task* rtask = new(task::allocate_additional_child_of(*(this->my_graph.root_task()))) internal::forward_task_bypass<limiter_node<T>>(*this);
        ...
        public:
            ...
            limiter_node(graph& g, size_t threshold, int num_decrement_predecessors = 0)
                ...
                tbb::internal::fgt_node(tbb::internal::FLOW_LIMITER_NODE, &this->my_graph, static_cast<receiver<input_type>*>(this), static_cast<receiver<continue_msg>*>(&decrement), static_cast<sender<output_type>*>(this));
            }
            ...
            bool register_successor(successor_type& r) __TBB_override {
                ...
                if(was_empty && !my_predecessors.empty() && my_count + my_tries < my_threshold) {
                    if(internal::is_graph_active(this->my_graph)) {
                        task* task = new(task::allocate_additional_child_of(*(this->my_graph.root_task()))) internal::forward_task_bypass<limiter_node<T>>(*this);
            ...
            void internal_add_built_successor(successor_type& src) __TBB_override { my_successors.internal_add_built_successor(src); }

            void internal_delete_built_successor(successor_type& src) __TBB_override { my_successors.internal_delete_built_successor(src); }

            size_t successor_count() __TBB_override { return my_successors.successor_count(); }

            void copy_successors(successor_list_type& v) __TBB_override { my_successors.copy_successors(v); }

            void internal_add_built_predecessor(predecessor_type& src) __TBB_override { my_predecessors.internal_add_built_predecessor(src); }

            void internal_delete_built_predecessor(predecessor_type& src) __TBB_override { my_predecessors.internal_delete_built_predecessor(src); }

            size_t predecessor_count() __TBB_override { return my_predecessors.predecessor_count(); }

            void copy_predecessors(predecessor_list_type& v) __TBB_override { my_predecessors.copy_predecessors(v); }
        ...
        protected:
            ...
            task* try_put_task(const T& t) __TBB_override {
                ...
                if(!rtask) { // try_put_task failed.
                    spin_mutex::scoped_lock lock(my_mutex);
                    --my_tries;
                    if(check_conditions() && internal::is_graph_active(this->my_graph)) { rtask = new(task::allocate_additional_child_of(*(this->my_graph.root_task()))) internal::forward_task_bypass<limiter_node<T>>(*this); }
                } else {
                    spin_mutex::scoped_lock lock(my_mutex);
                    ++my_count;
                    --my_tries;
...
#include "internal/_flow_graph_join_impl.h"
        ...
        public:
            ...
            explicit join_node(graph& g)
                : unfolded_type(g) {
                tbb::internal::fgt_multiinput_node<N>(tbb::internal::FLOW_JOIN_NODE_RESERVING, &this->my_graph, this->input_ports(), static_cast<sender<output_type>*>(this));
            }
        ...
        public:
            ...
            explicit join_node(graph& g)
                : unfolded_type(g) {
                tbb::internal::fgt_multiinput_node<N>(tbb::internal::FLOW_JOIN_NODE_QUEUEING, &this->my_graph, this->input_ports(), static_cast<sender<output_type>*>(this));
            }
            join_node(const join_node& other)
                : unfolded_type(other) {
                tbb::internal::fgt_multiinput_node<N>(tbb::internal::FLOW_JOIN_NODE_QUEUEING, &this->my_graph, this->input_ports(), static_cast<sender<output_type>*>(this));
        ...
        template <typename OutputTuple, typename K, typename KHash> class join_node<OutputTuple, key_matching<K, KHash>> : public internal::unfolded_join_node<tbb::flow::tuple_size<OutputTuple>::value, key_matching_port, OutputTuple, key_matching<K, KHash>> {
        private:
            static const int N = tbb::flow::tuple_size<OutputTuple>::value;
        ...
        public:
            ...
            join_node(graph& g, __TBB_B0 b0, __TBB_B1 b1)
                ...
                tbb::internal::fgt_multiinput_node<N>(tbb::internal::FLOW_JOIN_NODE_TAG_MATCHING, &this->my_graph, this->input_ports(), static_cast<sender<output_type>*>(this));
            }
...
#include "internal/_flow_graph_indexer_impl.h"
        ...
        template <typename T0, typename T1 = null_type, typename T2 = null_type, typename T3 = null_type, typename T4 = null_type, typename T5 = null_type, typename T6 = null_type, typename T7 = null_type, typename T8 = null_type, typename T9 = null_type> class indexer_node;
        ...
        public:
            ...
            indexer_node(graph& g)
                : unfolded_type(g) {
                tbb::internal::fgt_multiinput_node<N>(tbb::internal::FLOW_INDEXER_NODE, &this->my_graph, this->input_ports(), static_cast<sender<output_type>*>(this));
            }
            // Copy constructor
...
#if TBB_PREVIEW_FLOW_GRAPH_TRACE
            void set_name(const char* name) { tbb::internal::fgt_node_desc(this, name); }
#endif
        };
...
#if __TBB_VARIADIC_MAX >= 7
        template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6> class indexer_node<T0, T1, T2, T3, T4, T5, T6> : public internal::unfolded_indexer_node<tuple<T0, T1, T2, T3, T4, T5, T6>> {
        private:
...
#if __TBB_VARIADIC_MAX >= 8
        template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7> class indexer_node<T0, T1, T2, T3, T4, T5, T6, T7> : public internal::unfolded_indexer_node<tuple<T0, T1, T2, T3, T4, T5, T6, T7>> {
        private:
...
#if __TBB_VARIADIC_MAX >= 9
        template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8> class indexer_node<T0, T1, T2, T3, T4, T5, T6, T7, T8> : public internal::unfolded_indexer_node<tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8>> {
        private:
...
#if __TBB_VARIADIC_MAX >= 10
        template <typename T0, typename T1, typename T2, typename T3, typename T4, typename T5, typename T6, typename T7, typename T8, typename T9> class indexer_node /*default*/ : public internal::unfolded_indexer_node<tuple<T0, T1, T2, T3, T4, T5, T6, T7, T8, T9>> {
        private:
...
#if __TBB_PREVIEW_ASYNC_MSG
        template <typename TS, typename TR, typename = typename tbb::internal::enable_if<tbb::internal::is_same_type<TS, internal::untyped_sender>::value || tbb::internal::is_same_type<TR, internal::untyped_receiver>::value>::type> inline void make_edge(TS& p, TR& s) { internal_make_edge(p, s); }

        template <typename T> inline void make_edge(sender<T>& p, receiver<typename T::async_msg_data_type>& s) { internal_make_edge(p, s); }

        template <typename T> inline void make_edge(sender<typename T::async_msg_data_type>& p, receiver<T>& s) { internal_make_edge(p, s); }
        ...
        template <typename T, typename V, typename = typename T::output_ports_type, typename = typename V::input_ports_type> inline void make_edge(T& output, V& input) { make_edge(get<0>(output.output_ports()), get<0>(input.input_ports())); }

        // Makes an edge from port 0 of a multi-output predecessor to a receiver.
        template <typename T, typename R, typename = typename T::output_ports_type> inline void make_edge(T& output, receiver<R>& input) { make_edge(get<0>(output.output_ports()), input); }

        // Makes an edge from a sender to port 0 of a multi-input successor.
        template <typename S, typename V, typename = typename V::input_ports_type> inline void make_edge(sender<S>& output, V& input) { make_edge(output, get<0>(input.input_ports())); }
#endif
...
#if __TBB_PREVIEW_ASYNC_MSG
        template <typename TS, typename TR, typename = typename tbb::internal::enable_if<tbb::internal::is_same_type<TS, internal::untyped_sender>::value || tbb::internal::is_same_type<TR, internal::untyped_receiver>::value>::type> inline void remove_edge(TS& p, TR& s) { internal_remove_edge(p, s); }

        template <typename T> inline void remove_edge(sender<T>& p, receiver<typename T::async_msg_data_type>& s) { internal_remove_edge(p, s); }

        template <typename T> inline void remove_edge(sender<typename T::async_msg_data_type>& p, receiver<T>& s) { internal_remove_edge(p, s); }
#endif // __TBB_PREVIEW_ASYNC_MSG

#if __TBB_FLOW_GRAPH_CPP11_FEATURES
        // Removes an edge between port 0 of a multi-output predecessor and port 0 of a multi-input successor.
        template <typename T, typename V, typename = typename T::output_ports_type, typename = typename V::input_ports_type> inline void remove_edge(T& output, V& input) { remove_edge(get<0>(output.output_ports()), get<0>(input.input_ports())); }

        // Removes an edge between port 0 of a multi-output predecessor and a receiver.
        template <typename T, typename R, typename = typename T::output_ports_type> inline void remove_edge(T& output, receiver<R>& input) { remove_edge(get<0>(output.output_ports()), input); }
        // Removes an edge between a sender and port 0 of a multi-input successor.
        template <typename S, typename V, typename = typename V::input_ports_type> inline void remove_edge(sender<S>& output, V& input) { remove_edge(output, get<0>(input.input_ports())); }
#endif

#if TBB_PREVIEW_FLOW_GRAPH_FEATURES
        template <typename C> template <typename S> void internal::edge_container<C>::sender_extract(S& s) {
            edge_list_type e = built_edges;
            for(typename edge_list_type::iterator i = e.begin(); i != e.end(); ++i) { remove_edge(s, **i); }
        }

        template <typename C> template <typename R> void internal::edge_container<C>::receiver_extract(R& r) {
            edge_list_type e = built_edges;
            for(typename edge_list_type::iterator i = e.begin(); i != e.end(); ++i) { remove_edge(**i, r); }
        }
#endif /* TBB_PREVIEW_FLOW_GRAPH_FEATURES */
        ...
        public:
#if TBB_PREVIEW_FLOW_GRAPH_TRACE
            composite_node(graph& g, const char* type_name)
                : graph_node(g)
...
#if TBB_PREVIEW_FLOW_GRAPH_TRACE
            void set_name(const char* name) __TBB_override { tbb::internal::fgt_multiinput_multioutput_node_desc(this, name); }
#endif
...
#if TBB_PREVIEW_FLOW_GRAPH_FEATURES
            void extract() __TBB_override { __TBB_ASSERT(false, "Current composite_node implementation does not support extract"); }
#endif
        ...
        template <typename Input, typename Output, typename Policy = queueing, typename Allocator = cache_aligned_allocator<Input>> class async_node : public multifunction_node<Input, tuple<Output>, Policy, Allocator>, public sender<Output> {
        ...
        public:
            ...
            async_node(graph& g, size_t concurrency, Body body)
                : base_type(g, concurrency, internal::async_body<Input, typename base_type::output_ports_type, gateway_type, Body>(body, &my_gateway))
                , my_gateway(self()) {
                tbb::internal::fgt_multioutput_node_with_body<1>(tbb::internal::FLOW_ASYNC_NODE, &this->my_graph, static_cast<receiver<input_type>*>(this), this->output_ports(), this->my_body);
            }
            ...
            void internal_add_built_successor(successor_type& r) __TBB_override { internal::output_port<0>(*this).internal_add_built_successor(r); }

            void internal_delete_built_successor(successor_type& r) __TBB_override { internal::output_port<0>(*this).internal_delete_built_successor(r); }

            void copy_successors(successor_list_type& l) __TBB_override { internal::output_port<0>(*this).copy_successors(l); }

            size_t successor_count() __TBB_override { return internal::output_port<0>(*this).successor_count(); }
#endif
