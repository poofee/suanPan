...
#ifndef __TBB_Pause
inline void __TBB_Pause(int32_t) { __TBB_Yield(); }
#endif
...
#define __TBB_MACHINE_DEFINE_ATOMIC_SELECTOR_FETCH_STORE(S) \
    atomic_selector<S>::word atomic_selector<S>::fetch_store(volatile void* location, word value) { return __TBB_machine_fetchstore##S(location, value); }
...
// in general, plain load and store of 32bit compiler is not atomic for 64bit types
    ...
    template <typename T> struct machine_load_store<T, 8> {
        static T load_with_acquire(const volatile T& location) { return (T)__TBB_machine_load8((const volatile void*)&location); }
        static void store_with_release(volatile T& location, T value) { __TBB_machine_store8((volatile void*)&location, (int64_t)value); }
    };
    ...
    template <typename T> struct machine_load_store_seq_cst<T, 8> {
        static T load(const volatile T& location) {
            // Comparand and new value may be anything, they only must be equal, and
            // the value should have a low probability to be actually found in 'location'.
            const int64_t anyvalue = 2305843009213693951LL;
...
#endif
            while(__TBB_machine_cmpswp8((volatile void*)&location, (int64_t)value, result) != result) result = (volatile int64_t&)location;
        }
    };
#endif /* __TBB_WORDSIZE==4 && __TBB_64BIT_ATOMICS */
...
#if __TBB_WORDSIZE == 4 && __TBB_64BIT_ATOMICS
    template <typename T> struct machine_load_store_relaxed<T, 8> {
        static inline T load(const volatile T& location) { return (T)__TBB_machine_load8((const volatile void*)&location); }
        static inline void store(volatile T& location, T value) { __TBB_machine_store8((volatile void*)&location, (int64_t)value); }
    };
#endif /* __TBB_WORDSIZE==4 && __TBB_64BIT_ATOMICS */
...
#define __TBB_DefineTypeWithAlignment(PowerOf2) \
    __declspec(align(PowerOf2)) struct __TBB_machine_type_with_alignment_##PowerOf2 { uint32_t member[PowerOf2 / sizeof(uint32_t)]; };
...
#error Must define __TBB_TypeWithAlignmentAtLeastAsStrict(T)
    ...
    __TBB_DefineTypeWithAlignment(16) __TBB_DefineTypeWithAlignment(32) __TBB_DefineTypeWithAlignment(64)
    ...
    template <size_t Size, typename T> struct work_around_alignment_bug { static const size_t alignment = __TBB_alignof(T); };
...
#define __TBB_TypeWithAlignmentAtLeastAsStrict(T) tbb::internal::type_with_alignment<__TBB_alignof(T)>
    ...
    template <typename T> struct reverse { static const T byte_table[256]; };
    ...
    template <typename T>
    const T reverse<T>::byte_table[256] = {  };
