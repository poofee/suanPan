...
public:
    ...
    mutex() {
        ...
        if(error_code) tbb::internal::handle_perror(error_code, "mutex: pthread_mutex_init failed");
#endif /* _WIN32||_WIN64*/
    ...
    void lock() {
        ...
        if(error_code) tbb::internal::handle_perror(error_code, "mutex: pthread_mutex_lock failed");
#endif /* _WIN32||_WIN64 */
#endif /* TBB_USE_ASSERT */
    }
