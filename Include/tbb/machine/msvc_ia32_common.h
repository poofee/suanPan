...
#define __TBB_MACHINE_DEFINE_ATOMICS(S, B, T, U)                                                                                                                                                                \
    __pragma(intrinsic(_InterlockedCompareExchange##B)) static inline T __TBB_machine_cmpswp##S(volatile void* ptr, U value, U comparand) { return _InterlockedCompareExchange##B((T*)ptr, value, comparand); } \
    __pragma(intrinsic(_InterlockedExchangeAdd##B)) static inline T __TBB_machine_fetchadd##S(volatile void* ptr, U addend) { return _InterlockedExchangeAdd##B((T*)ptr, addend); }                             \
    __pragma(intrinsic(_InterlockedExchange##B)) static inline T __TBB_machine_fetchstore##S(volatile void* ptr, U value) { return _InterlockedExchange##B((T*)ptr, value); }
...
namespace internal {
    namespace msvc_intrinsics {
        static inline void lock_or(volatile void* operand, intptr_t addend) { __TBB_W(_InterlockedOr)((volatile word*)operand, addend); }
        static inline void lock_and(volatile void* operand, intptr_t addend) { __TBB_W(_InterlockedAnd)((volatile word*)operand, addend); }
    }
}
}
