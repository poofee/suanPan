...
#define __TBB_MACHINE_DEFINE_ATOMICS_CMPSWP(S, T, F) \
    inline T __TBB_machine_cmpswp##S(volatile void* ptr, T value, T comparand) { return _InterlockedCompareExchange##F(reinterpret_cast<volatile T*>(ptr), value, comparand); }

#define __TBB_MACHINE_DEFINE_ATOMICS_FETCHADD(S, T, F) \
    inline T __TBB_machine_fetchadd##S(volatile void* ptr, T value) { return _InterlockedExchangeAdd##F(reinterpret_cast<volatile T*>(ptr), value); }
