...
#define __TBB_MACHINE_DEFINE_ATOMICS(S, T)                                                                                                                                   \
    inline T __TBB_machine_cmpswp##S(volatile void* ptr, T value, T comparand) { return __sync_val_compare_and_swap(reinterpret_cast<volatile T*>(ptr), comparand, value); } \
    inline T __TBB_machine_fetchadd##S(volatile void* ptr, T value) { return __sync_fetch_and_add(reinterpret_cast<volatile T*>(ptr), value); }
...
#define __TBB_MACHINE_DEFINE_ATOMICS(S, T)                                                                                                                      \
    inline T __TBB_machine_cmpswp##S(volatile void* ptr, T value, T comparand) {                                                                                \
        (void)__atomic_compare_exchange_n(reinterpret_cast<volatile T*>(ptr), &comparand, value, false, __ATOMIC_SEQ_CST, __ATOMIC_SEQ_CST);                    \
        return comparand;                                                                                                                                       \
    }                                                                                                                                                           \
    inline T __TBB_machine_fetchadd##S(volatile void* ptr, T value) { return __atomic_fetch_add(reinterpret_cast<volatile T*>(ptr), value, __ATOMIC_SEQ_CST); } \
    inline T __TBB_machine_fetchstore##S(volatile void* ptr, T value) { return __atomic_exchange_n(reinterpret_cast<volatile T*>(ptr), value, __ATOMIC_SEQ_CST); }
...
static inline intptr_t __TBB_machine_lg(uintptr_t x) { return sizeof(x) * 8 - tbb::internal::gcc_builtins::clz(x) - 1; }
...
static inline void __TBB_machine_or(volatile void* ptr, uintptr_t addend) { __atomic_fetch_or(reinterpret_cast<volatile uintptr_t*>(ptr), addend, __ATOMIC_SEQ_CST); }

static inline void __TBB_machine_and(volatile void* ptr, uintptr_t addend) { __atomic_fetch_and(reinterpret_cast<volatile uintptr_t*>(ptr), addend, __ATOMIC_SEQ_CST); }

inline bool __TBB_machine_try_lock_byte(__TBB_atomic_flag& flag) { return !__atomic_test_and_set(&flag, __ATOMIC_ACQUIRE); }

inline void __TBB_machine_unlock_byte(__TBB_atomic_flag& flag) { __atomic_clear(&flag, __ATOMIC_RELEASE); }
