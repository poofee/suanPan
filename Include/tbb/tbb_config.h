...
#define __TBB_EXCEPTION_PTR_PRESENT                                                                   \
    (__INTEL_COMPILER > 1300 /*ICC 12.1 Upd 10 and 13 beta Upd 2 fixed exception_ptr linking  issue*/ \
        || (__INTEL_COMPILER == 1300 && __INTEL_COMPILER_BUILD_DATE >= 20120530) || (__INTEL_COMPILER == 1210 && __INTEL_COMPILER_BUILD_DATE >= 20120410))
...
#define __TBB_ALLOCATOR_TRAITS_PRESENT (__cplusplus >= 201103L && _LIBCPP_VERSION || _MSC_VER >= 1700 || __GXX_EXPERIMENTAL_CXX0X__ && __TBB_GLIBCXX_VERSION >= 40700 && !(__TBB_GLIBCXX_VERSION == 40700 && __TBB_DEFINE_MIC))
...
#define __TBB_ITT_STRUCTURE_API ((__TBB_CPF_BUILD || TBB_PREVIEW_FLOW_GRAPH_TRACE || TBB_PREVIEW_ALGORITHM_TRACE) && !(__TBB_DEFINE_MIC || __MINGW64__ || __MINGW32__))
#endif
...
#if !defined(__TBB_SURVIVE_THREAD_SWITCH) && (_WIN32 || _WIN64 || __APPLE__ || (__linux__ && !__ANDROID__))
...
#if __GXX_EXPERIMENTAL_CXX0X__ && !defined(__EXCEPTIONS) && ((!__INTEL_COMPILER && !__clang__ && (__TBB_GCC_VERSION >= 40400 && __TBB_GCC_VERSION < 40600)) || (__INTEL_COMPILER <= 1400 && (__TBB_GLIBCXX_VERSION >= 40400 && __TBB_GLIBCXX_VERSION <= 40801)))
...
#if __TBB_x86_32 && (__INTEL_COMPILER || (__GNUC__ == 5 && __GNUC_MINOR__ >= 2 && __GXX_EXPERIMENTAL_CXX0X__) || (__GNUC__ == 3 && __GNUC_MINOR__ == 3) || (__MINGW32__ && __GNUC__ == 4 && __GNUC_MINOR__ == 5) || __SUNPRO_CC)
...
#define __TBB_FLOW_GRAPH_CPP11_FEATURES (__TBB_CPP11_VARIADIC_TEMPLATES_PRESENT && __TBB_CPP11_SMART_POINTERS_PRESENT && __TBB_CPP11_RVALUE_REF_PRESENT && __TBB_CPP11_AUTO_PRESENT) && __TBB_CPP11_VARIADIC_TUPLE_PRESENT&& __TBB_CPP11_DEFAULT_FUNC_TEMPLATE_ARGS_PRESENT && !__TBB_UPCAST_OF_TUPLE_OF_REF_BROKEN
#define __TBB_PREVIEW_STREAMING_NODE (__TBB_CPP11_VARIADIC_FIXED_LENGTH_EXP_PRESENT && __TBB_FLOW_GRAPH_CPP11_FEATURES && TBB_PREVIEW_FLOW_GRAPH_NODES && !TBB_IMPLEMENT_CPP0X && !__TBB_UPCAST_OF_TUPLE_OF_REF_BROKEN)
...
#define __TBB_PREVIEW_GFX_FACTORY (__TBB_GFX_PRESENT && TBB_PREVIEW_FLOW_GRAPH_FEATURES && !__TBB_MIC_OFFLOAD && __TBB_FLOW_GRAPH_CPP11_FEATURES && __TBB_CPP11_TEMPLATE_ALIASES_PRESENT && __TBB_CPP11_FUTURE_PRESENT)
