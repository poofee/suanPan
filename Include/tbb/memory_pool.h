...
#pragma warning(disable : 4100)
    ...
    public:
        ...
        template <typename U> struct rebind { typedef memory_pool_allocator<U, P> other; };
...
#pragma warning(pop)
    ...
    memory_pool<Alloc>::memory_pool(const Alloc& src)
        : my_alloc(src) {
        rml::MemPoolPolicy args(allocate_request, deallocate_request, sizeof(typename Alloc::value_type));
