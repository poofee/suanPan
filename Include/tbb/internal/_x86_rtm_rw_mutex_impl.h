...
namespace interface8 {
    namespace internal {
        ...
        enum RTM_type { RTM_not_in_mutex, RTM_transacting_reader, RTM_transacting_writer, RTM_real_reader, RTM_real_writer };
        ...
        private:
            ...
            static x86_rtm_rw_mutex* internal_get_mutex(const spin_rw_mutex::scoped_lock& lock) { return static_cast<x86_rtm_rw_mutex*>(lock.internal_get_mutex()); }
            static void internal_set_mutex(spin_rw_mutex::scoped_lock& lock, spin_rw_mutex* mtx) { lock.internal_set_mutex(mtx); }
            //! @endcond
        public:
