...
template <typename TupleTypes, int N> struct indexer_helper {
    ...
    template <typename InputTuple> static inline void extract(InputTuple& my_input) {
...
#if TBB_PREVIEW_FLOW_GRAPH_FEATURES
    template <typename InputTuple> static inline void extract(InputTuple& my_input) { tbb::flow::get<0>(my_input).extract_receiver(); }
#endif
};
...
//! indexer_node_base
template <typename InputTuple, typename OutputType, typename StructTypes> class indexer_node_base : public graph_node, public indexer_node_FE<InputTuple, OutputType, StructTypes>, public sender<OutputType> {
protected:
...
template <typename InputTuple> struct input_types<4, InputTuple> {
    ...
    typedef typename internal::tagged_msg<size_t, first_type, second_type, third_type, fourth_type> type;
};
...
template <typename InputTuple> struct input_types<5, InputTuple> {
    ...
    typedef typename internal::tagged_msg<size_t, first_type, second_type, third_type, fourth_type, fifth_type> type;
};
...
template <typename InputTuple> struct input_types<6, InputTuple> {
    ...
    typedef typename internal::tagged_msg<size_t, first_type, second_type, third_type, fourth_type, fifth_type, sixth_type> type;
};
...
template <typename InputTuple> struct input_types<7, InputTuple> {
    ...
    typedef typename internal::tagged_msg<size_t, first_type, second_type, third_type, fourth_type, fifth_type, sixth_type, seventh_type> type;
};
...
template <typename InputTuple> struct input_types<8, InputTuple> {
    ...
    typedef typename internal::tagged_msg<size_t, first_type, second_type, third_type, fourth_type, fifth_type, sixth_type, seventh_type, eighth_type> type;
};
...
template <typename InputTuple> struct input_types<9, InputTuple> {
    ...
    typedef typename internal::tagged_msg<size_t, first_type, second_type, third_type, fourth_type, fifth_type, sixth_type, seventh_type, eighth_type, nineth_type> type;
};
...
template <typename InputTuple> struct input_types<10, InputTuple> {
    ...
    typedef typename internal::tagged_msg<size_t, first_type, second_type, third_type, fourth_type, fifth_type, sixth_type, seventh_type, eighth_type, nineth_type, tenth_type> type;
};
