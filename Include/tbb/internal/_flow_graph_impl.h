...
namespace flow {
    ...
    namespace interface10 {
        ...
        class graph : tbb::internal::no_copy, public tbb::flow::graph_proxy {
            ...
            template <typename Body> class run_task : public task {
            public:
                run_task(Body& body)
                    : my_body(body) {}
            ...
            template <typename Receiver, typename Body> class run_and_put_task : public task {
            public:
        ...
        public:
            ...
            template <typename Receiver, typename Body> void run(Receiver& r, Body body) {
                if(internal::is_graph_active(*this)) {
                    task* rtask = new(task::allocate_additional_child_of(*root_task())) run_and_put_task<Receiver, Body>(r, body);
