 ...
 */
void magmablas_dprbt(magma_int_t n, magmaDouble_ptr dA, magma_int_t ldda, magmaDouble_ptr du, magmaDouble_ptr dv, magma_queue_t queue);

void magmablas_dprbt_mv(magma_int_t n, magmaDouble_ptr dv, magmaDouble_ptr db, magma_queue_t queue);

void magmablas_dprbt_mtv(magma_int_t n, magmaDouble_ptr du, magmaDouble_ptr db, magma_queue_t queue);

/*
 * Multi-GPU copy functions
 */
void magma_dgetmatrix_1D_col_bcyclic(magma_int_t ngpu, magma_int_t m, magma_int_t n, magma_int_t nb, magmaDouble_const_ptr const dA[], magma_int_t ldda, double* hA, magma_int_t lda, magma_queue_t queue[]);

void magma_dsetmatrix_1D_col_bcyclic(magma_int_t ngpu, magma_int_t m, magma_int_t n, magma_int_t nb, const double* hA, magma_int_t lda, magmaDouble_ptr dA[], magma_int_t ldda, magma_queue_t queue[]);

void magma_dgetmatrix_1D_row_bcyclic(magma_int_t ngpu, magma_int_t m, magma_int_t n, magma_int_t nb, magmaDouble_const_ptr const dA[], magma_int_t ldda, double* hA, magma_int_t lda, magma_queue_t queue[]);

void magma_dsetmatrix_1D_row_bcyclic(magma_int_t ngpu, magma_int_t m, magma_int_t n, magma_int_t nb, const double* hA, magma_int_t lda, magmaDouble_ptr dA[], magma_int_t ldda, magma_queue_t queue[]);
...
void magmablas_dlacpy_conj(magma_int_t n, magmaDouble_ptr dA1, magma_int_t lda1, magmaDouble_ptr dA2, magma_int_t lda2, magma_queue_t queue);
...
void magmablas_dlaswp_sym(magma_int_t n, magmaDouble_ptr dA, magma_int_t ldda, magma_int_t k1, magma_int_t k2, const magma_int_t* ipiv, magma_int_t inci, magma_queue_t queue);
...
void magma_dlarfbx_gpu(magma_int_t m, magma_int_t k, magmaDouble_ptr V, magma_int_t ldv, magmaDouble_ptr dT, magma_int_t ldt, magmaDouble_ptr c, magmaDouble_ptr dwork, magma_queue_t queue);

void magma_dlarfg_gpu(magma_int_t n, magmaDouble_ptr dx0, magmaDouble_ptr dx, magmaDouble_ptr dtau, magmaDouble_ptr dxnorm, magmaDouble_ptr dAkk, magma_queue_t queue);

void magma_dlarfgtx_gpu(magma_int_t n, magmaDouble_ptr dx0, magmaDouble_ptr dx, magmaDouble_ptr dtau, magmaDouble_ptr dxnorm, magmaDouble_ptr dA, magma_int_t iter, magmaDouble_ptr V, magma_int_t ldv, magmaDouble_ptr T, magma_int_t ldt, magmaDouble_ptr dwork, magma_queue_t queue);

void magma_dlarfgx_gpu(magma_int_t n, magmaDouble_ptr dx0, magmaDouble_ptr dx, magmaDouble_ptr dtau, magmaDouble_ptr dxnorm, magmaDouble_ptr dA, magma_int_t iter, magma_queue_t queue);

void magma_dlarfx_gpu(magma_int_t m, magma_int_t n, magmaDouble_ptr v, magmaDouble_ptr tau, magmaDouble_ptr C, magma_int_t ldc, magmaDouble_ptr xnorm, magmaDouble_ptr dT, magma_int_t iter, magmaDouble_ptr work, magma_queue_t queue);

/*
 * Level 1 BLAS (alphabetical order)
 */
void magmablas_daxpycp(magma_int_t m, magmaDouble_ptr dr, magmaDouble_ptr dx, magmaDouble_const_ptr db, magma_queue_t queue);
...
void magmablas_dnrm2_adjust(magma_int_t k, magmaDouble_ptr dxnorm, magmaDouble_ptr dc, magma_queue_t queue);
...
void magmablas_dnrm2_cols(magma_int_t m, magma_int_t n, magmaDouble_ptr dA, magma_int_t ldda, magmaDouble_ptr dxnorm, magma_queue_t queue);

void magmablas_dnrm2_row_check_adjust(magma_int_t k, double tol, magmaDouble_ptr dxnorm, magmaDouble_ptr dxnorm2, magmaDouble_ptr dC, magma_int_t lddc, magmaDouble_ptr dlsticc, magma_queue_t queue);
 ...
 */
void magmablas_dgemm(magma_trans_t transA, magma_trans_t transB, magma_int_t m, magma_int_t n, magma_int_t k, double alpha, magmaDouble_const_ptr dA, magma_int_t ldda, magmaDouble_const_ptr dB, magma_int_t lddb, double beta, magmaDouble_ptr dC, magma_int_t lddc, magma_queue_t queue);
...
void magmablas_dsyr2k(magma_uplo_t uplo, magma_trans_t trans, magma_int_t n, magma_int_t k, double alpha, magmaDouble_const_ptr dA, magma_int_t ldda, magmaDouble_const_ptr dB, magma_int_t lddb, double beta, magmaDouble_ptr dC, magma_int_t lddc, magma_queue_t queue);

void magmablas_dsyr2k(magma_uplo_t uplo, magma_trans_t trans, magma_int_t n, magma_int_t k, double alpha, magmaDouble_const_ptr dA, magma_int_t ldda, magmaDouble_const_ptr dB, magma_int_t lddb, double beta, magmaDouble_ptr dC, magma_int_t lddc, magma_queue_t queue);

void magmablas_dsyrk(magma_uplo_t uplo, magma_trans_t trans, magma_int_t n, magma_int_t k, double alpha, magmaDouble_const_ptr dA, magma_int_t ldda, double beta, magmaDouble_ptr dC, magma_int_t lddc, magma_queue_t queue);
...
#define magma_dsetvector(n, hx_src, incx, dy_dst, incy, queue) magma_dsetvector_internal(n, hx_src, incx, dy_dst, incy, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_getvector() for double arrays.
/// @ingroup magma_getvector
#define magma_dgetvector(n, dx_src, incx, hy_dst, incy, queue) magma_dgetvector_internal(n, dx_src, incx, hy_dst, incy, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_copyvector() for double arrays.
/// @ingroup magma_copyvector
#define magma_dcopyvector(n, dx_src, incx, dy_dst, incy, queue) magma_dcopyvector_internal(n, dx_src, incx, dy_dst, incy, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_setvector_async() for double arrays.
/// @ingroup magma_setvector
#define magma_dsetvector_async(n, hx_src, incx, dy_dst, incy, queue) magma_dsetvector_async_internal(n, hx_src, incx, dy_dst, incy, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_getvector_async() for double arrays.
/// @ingroup magma_getvector
#define magma_dgetvector_async(n, dx_src, incx, hy_dst, incy, queue) magma_dgetvector_async_internal(n, dx_src, incx, hy_dst, incy, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_copyvector_async() for double arrays.
/// @ingroup magma_copyvector
#define magma_dcopyvector_async(n, dx_src, incx, dy_dst, incy, queue) magma_dcopyvector_async_internal(n, dx_src, incx, dy_dst, incy, queue, __func__, __FILE__, __LINE__)

static inline void magma_dsetvector_internal(magma_int_t n, double const* hx_src, magma_int_t incx, magmaDouble_ptr dy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_setvector_internal(n, sizeof(double), hx_src, incx, dy_dst, incy, queue, func, file, line); }

static inline void magma_dgetvector_internal(magma_int_t n, magmaDouble_const_ptr dx_src, magma_int_t incx, double* hy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_getvector_internal(n, sizeof(double), dx_src, incx, hy_dst, incy, queue, func, file, line); }

static inline void magma_dcopyvector_internal(magma_int_t n, magmaDouble_const_ptr dx_src, magma_int_t incx, magmaDouble_ptr dy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_copyvector_internal(n, sizeof(double), dx_src, incx, dy_dst, incy, queue, func, file, line); }

static inline void magma_dsetvector_async_internal(magma_int_t n, double const* hx_src, magma_int_t incx, magmaDouble_ptr dy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_setvector_async_internal(n, sizeof(double), hx_src, incx, dy_dst, incy, queue, func, file, line); }

static inline void magma_dgetvector_async_internal(magma_int_t n, magmaDouble_const_ptr dx_src, magma_int_t incx, double* hy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_getvector_async_internal(n, sizeof(double), dx_src, incx, hy_dst, incy, queue, func, file, line); }

static inline void magma_dcopyvector_async_internal(magma_int_t n, magmaDouble_const_ptr dx_src, magma_int_t incx, magmaDouble_ptr dy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_copyvector_async_internal(n, sizeof(double), dx_src, incx, dy_dst, incy, queue, func, file, line); }
...
#define magma_dsetmatrix(m, n, hA_src, lda, dB_dst, lddb, queue) magma_dsetmatrix_internal(m, n, hA_src, lda, dB_dst, lddb, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_getmatrix() for double arrays.
/// @ingroup magma_getmatrix
#define magma_dgetmatrix(m, n, dA_src, ldda, hB_dst, ldb, queue) magma_dgetmatrix_internal(m, n, dA_src, ldda, hB_dst, ldb, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_copymatrix() for double arrays.
/// @ingroup magma_copymatrix
#define magma_dcopymatrix(m, n, dA_src, ldda, dB_dst, lddb, queue) magma_dcopymatrix_internal(m, n, dA_src, ldda, dB_dst, lddb, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_setmatrix_async() for double arrays.
/// @ingroup magma_setmatrix
#define magma_dsetmatrix_async(m, n, hA_src, lda, dB_dst, lddb, queue) magma_dsetmatrix_async_internal(m, n, hA_src, lda, dB_dst, lddb, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_getmatrix_async() for double arrays.
/// @ingroup magma_getmatrix
#define magma_dgetmatrix_async(m, n, dA_src, ldda, hB_dst, ldb, queue) magma_dgetmatrix_async_internal(m, n, dA_src, ldda, hB_dst, ldb, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_copymatrix_async() for double arrays.
/// @ingroup magma_copymatrix
#define magma_dcopymatrix_async(m, n, dA_src, ldda, dB_dst, lddb, queue) magma_dcopymatrix_async_internal(m, n, dA_src, ldda, dB_dst, lddb, queue, __func__, __FILE__, __LINE__)

static inline void magma_dsetmatrix_internal(magma_int_t m, magma_int_t n, double const* hA_src, magma_int_t lda, magmaDouble_ptr dB_dst, magma_int_t lddb, magma_queue_t queue, const char* func, const char* file, int line) { magma_setmatrix_internal(m, n, sizeof(double), hA_src, lda, dB_dst, lddb, queue, func, file, line); }

static inline void magma_dgetmatrix_internal(magma_int_t m, magma_int_t n, magmaDouble_const_ptr dA_src, magma_int_t ldda, double* hB_dst, magma_int_t ldb, magma_queue_t queue, const char* func, const char* file, int line) { magma_getmatrix_internal(m, n, sizeof(double), dA_src, ldda, hB_dst, ldb, queue, func, file, line); }

static inline void magma_dcopymatrix_internal(magma_int_t m, magma_int_t n, magmaDouble_const_ptr dA_src, magma_int_t ldda, magmaDouble_ptr dB_dst, magma_int_t lddb, magma_queue_t queue, const char* func, const char* file, int line) { magma_copymatrix_internal(m, n, sizeof(double), dA_src, ldda, dB_dst, lddb, queue, func, file, line); }

static inline void magma_dsetmatrix_async_internal(magma_int_t m, magma_int_t n, double const* hA_src, magma_int_t lda, magmaDouble_ptr dB_dst, magma_int_t lddb, magma_queue_t queue, const char* func, const char* file, int line) { magma_setmatrix_async_internal(m, n, sizeof(double), hA_src, lda, dB_dst, lddb, queue, func, file, line); }

static inline void magma_dgetmatrix_async_internal(magma_int_t m, magma_int_t n, magmaDouble_const_ptr dA_src, magma_int_t ldda, double* hB_dst, magma_int_t ldb, magma_queue_t queue, const char* func, const char* file, int line) { magma_getmatrix_async_internal(m, n, sizeof(double), dA_src, ldda, hB_dst, ldb, queue, func, file, line); }

static inline void magma_dcopymatrix_async_internal(magma_int_t m, magma_int_t n, magmaDouble_const_ptr dA_src, magma_int_t ldda, magmaDouble_ptr dB_dst, magma_int_t lddb, magma_queue_t queue, const char* func, const char* file, int line) { magma_copymatrix_async_internal(m, n, sizeof(double), dA_src, ldda, dB_dst, lddb, queue, func, file, line); }
...
magma_int_t magma_idamin(magma_int_t n, magmaDouble_const_ptr dx, magma_int_t incx, magma_queue_t queue);
...
void magma_drot(magma_int_t n, magmaDouble_ptr dx, magma_int_t incx, magmaDouble_ptr dy, magma_int_t incy, double dc, double ds, magma_queue_t queue);
...
#ifdef REAL
void magma_drotm(magma_int_t n, magmaDouble_ptr dx, magma_int_t incx, magmaDouble_ptr dy, magma_int_t incy, magmaDouble_const_ptr param, magma_queue_t queue);

void magma_drotmg(magmaDouble_ptr d1, magmaDouble_ptr d2, magmaDouble_ptr x1, magmaDouble_const_ptr y1, magmaDouble_ptr param, magma_queue_t queue);
#endif
