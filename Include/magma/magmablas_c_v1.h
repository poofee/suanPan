/*
    -- MAGMA (version 2.3.0) --
       ...
       @generated from include/magmablas_z_v1.h, normal z -> c, Wed Nov 15 00:34:25 2017
*/
...
#define magma_csetvector_v1(n, hx_src, incx, dy_dst, incy) magma_csetvector_v1_internal(n, hx_src, incx, dy_dst, incy, __func__, __FILE__, __LINE__)

#define magma_cgetvector_v1(n, dx_src, incx, hy_dst, incy) magma_cgetvector_v1_internal(n, dx_src, incx, hy_dst, incy, __func__, __FILE__, __LINE__)

#define magma_ccopyvector_v1(n, dx_src, incx, dy_dst, incy) magma_ccopyvector_v1_internal(n, dx_src, incx, dy_dst, incy, __func__, __FILE__, __LINE__)

static inline void magma_csetvector_v1_internal(magma_int_t n, magmaFloatComplex const* hx_src, magma_int_t incx, magmaFloatComplex_ptr dy_dst, magma_int_t incy, const char* func, const char* file, int line) { magma_setvector_v1_internal(n, sizeof(magmaFloatComplex), hx_src, incx, dy_dst, incy, func, file, line); }

static inline void magma_cgetvector_v1_internal(magma_int_t n, magmaFloatComplex_const_ptr dx_src, magma_int_t incx, magmaFloatComplex* hy_dst, magma_int_t incy, const char* func, const char* file, int line) { magma_getvector_v1_internal(n, sizeof(magmaFloatComplex), dx_src, incx, hy_dst, incy, func, file, line); }

static inline void magma_ccopyvector_v1_internal(magma_int_t n, magmaFloatComplex_const_ptr dx_src, magma_int_t incx, magmaFloatComplex_ptr dy_dst, magma_int_t incy, const char* func, const char* file, int line) { magma_copyvector_v1_internal(n, sizeof(magmaFloatComplex), dx_src, incx, dy_dst, incy, func, file, line); }

// =============================================================================
// copying sub-matrices (contiguous columns)

#define magma_csetmatrix_v1(m, n, hA_src, lda, dB_dst, lddb) magma_csetmatrix_v1_internal(m, n, hA_src, lda, dB_dst, lddb, __func__, __FILE__, __LINE__)

#define magma_cgetmatrix_v1(m, n, dA_src, ldda, hB_dst, ldb) magma_cgetmatrix_v1_internal(m, n, dA_src, ldda, hB_dst, ldb, __func__, __FILE__, __LINE__)

#define magma_ccopymatrix_v1(m, n, dA_src, ldda, dB_dst, lddb) magma_ccopymatrix_v1_internal(m, n, dA_src, ldda, dB_dst, lddb, __func__, __FILE__, __LINE__)

static inline void magma_csetmatrix_v1_internal(magma_int_t m, magma_int_t n, magmaFloatComplex const* hA_src, magma_int_t lda, magmaFloatComplex_ptr dB_dst, magma_int_t lddb, const char* func, const char* file, int line) { magma_setmatrix_v1_internal(m, n, sizeof(magmaFloatComplex), hA_src, lda, dB_dst, lddb, func, file, line); }

static inline void magma_cgetmatrix_v1_internal(magma_int_t m, magma_int_t n, magmaFloatComplex_const_ptr dA_src, magma_int_t ldda, magmaFloatComplex* hB_dst, magma_int_t ldb, const char* func, const char* file, int line) { magma_getmatrix_v1_internal(m, n, sizeof(magmaFloatComplex), dA_src, ldda, hB_dst, ldb, func, file, line); }

static inline void magma_ccopymatrix_v1_internal(magma_int_t m, magma_int_t n, magmaFloatComplex_const_ptr dA_src, magma_int_t ldda, magmaFloatComplex_ptr dB_dst, magma_int_t lddb, const char* func, const char* file, int line) { magma_copymatrix_v1_internal(m, n, sizeof(magmaFloatComplex), dA_src, ldda, dB_dst, lddb, func, file, line); }
...
#ifdef REAL
void magma_crotm_v1(magma_int_t n, magmaFloat_ptr dx, magma_int_t incx, magmaFloat_ptr dy, magma_int_t incy, magmaFloat_const_ptr param);

void magma_crotmg_v1(magmaFloat_ptr d1, magmaFloat_ptr d2, magmaFloat_ptr x1, magmaFloat_const_ptr y1, magmaFloat_ptr param);
#endif
