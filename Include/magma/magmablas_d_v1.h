/*
    -- MAGMA (version 2.3.0) --
       ...
       @generated from include/magmablas_z_v1.h, normal z -> d, Wed Nov 15 00:34:25 2017
*/
...
#define magma_dsetvector_v1(n, hx_src, incx, dy_dst, incy) magma_dsetvector_v1_internal(n, hx_src, incx, dy_dst, incy, __func__, __FILE__, __LINE__)

#define magma_dgetvector_v1(n, dx_src, incx, hy_dst, incy) magma_dgetvector_v1_internal(n, dx_src, incx, hy_dst, incy, __func__, __FILE__, __LINE__)

#define magma_dcopyvector_v1(n, dx_src, incx, dy_dst, incy) magma_dcopyvector_v1_internal(n, dx_src, incx, dy_dst, incy, __func__, __FILE__, __LINE__)

static inline void magma_dsetvector_v1_internal(magma_int_t n, double const* hx_src, magma_int_t incx, magmaDouble_ptr dy_dst, magma_int_t incy, const char* func, const char* file, int line) { magma_setvector_v1_internal(n, sizeof(double), hx_src, incx, dy_dst, incy, func, file, line); }

static inline void magma_dgetvector_v1_internal(magma_int_t n, magmaDouble_const_ptr dx_src, magma_int_t incx, double* hy_dst, magma_int_t incy, const char* func, const char* file, int line) { magma_getvector_v1_internal(n, sizeof(double), dx_src, incx, hy_dst, incy, func, file, line); }

static inline void magma_dcopyvector_v1_internal(magma_int_t n, magmaDouble_const_ptr dx_src, magma_int_t incx, magmaDouble_ptr dy_dst, magma_int_t incy, const char* func, const char* file, int line) { magma_copyvector_v1_internal(n, sizeof(double), dx_src, incx, dy_dst, incy, func, file, line); }

// =============================================================================
// copying sub-matrices (contiguous columns)

#define magma_dsetmatrix_v1(m, n, hA_src, lda, dB_dst, lddb) magma_dsetmatrix_v1_internal(m, n, hA_src, lda, dB_dst, lddb, __func__, __FILE__, __LINE__)

#define magma_dgetmatrix_v1(m, n, dA_src, ldda, hB_dst, ldb) magma_dgetmatrix_v1_internal(m, n, dA_src, ldda, hB_dst, ldb, __func__, __FILE__, __LINE__)

#define magma_dcopymatrix_v1(m, n, dA_src, ldda, dB_dst, lddb) magma_dcopymatrix_v1_internal(m, n, dA_src, ldda, dB_dst, lddb, __func__, __FILE__, __LINE__)

static inline void magma_dsetmatrix_v1_internal(magma_int_t m, magma_int_t n, double const* hA_src, magma_int_t lda, magmaDouble_ptr dB_dst, magma_int_t lddb, const char* func, const char* file, int line) { magma_setmatrix_v1_internal(m, n, sizeof(double), hA_src, lda, dB_dst, lddb, func, file, line); }

static inline void magma_dgetmatrix_v1_internal(magma_int_t m, magma_int_t n, magmaDouble_const_ptr dA_src, magma_int_t ldda, double* hB_dst, magma_int_t ldb, const char* func, const char* file, int line) { magma_getmatrix_v1_internal(m, n, sizeof(double), dA_src, ldda, hB_dst, ldb, func, file, line); }

static inline void magma_dcopymatrix_v1_internal(magma_int_t m, magma_int_t n, magmaDouble_const_ptr dA_src, magma_int_t ldda, magmaDouble_ptr dB_dst, magma_int_t lddb, const char* func, const char* file, int line) { magma_copymatrix_v1_internal(m, n, sizeof(double), dA_src, ldda, dB_dst, lddb, func, file, line); }
