/*
    -- MAGMA (version 2.3.0) --
       ...
       @generated from include/magma_zlapack.h, normal z -> s, Wed Nov 15 00:34:25 2017
*/
...
void blasf77_ssyr(const char* uplo, const magma_int_t* n, const float* alpha, const float* x, const magma_int_t* incx, float* A, const magma_int_t* lda);
...
void blasf77_srotg(float* ca, const float* cb, float* c, float* s);

void blasf77_srot(const magma_int_t* n, float* x, const magma_int_t* incx, float* y, const magma_int_t* incy, const float* c, const float* s);
...
void lapackf77_sgbbrd(const char* vect,
    const magma_int_t* m,
    const magma_int_t* n,
...
void lapackf77_sgbsv(const magma_int_t* n, const magma_int_t* kl, const magma_int_t* ku, const magma_int_t* nrhs, float* ab, const magma_int_t* ldab, magma_int_t* ipiv, float* B, const magma_int_t* ldb, magma_int_t* info);
...
void lapackf77_ssytf2(const char* uplo, const magma_int_t* n, float* A, const magma_int_t* lda, magma_int_t* ipiv, magma_int_t* info);

void lapackf77_ssytrs(const char* uplo, const magma_int_t* n, const magma_int_t* nrhs, const float* A, const magma_int_t* lda, const magma_int_t* ipiv, float* B, const magma_int_t* ldb, magma_int_t* info);
...
void lapackf77_ssygs2(const magma_int_t* itype, const char* uplo, const magma_int_t* n, float* A, const magma_int_t* lda, const float* B, const magma_int_t* ldb, magma_int_t* info);

void lapackf77_ssygst(const magma_int_t* itype, const char* uplo, const magma_int_t* n, float* A, const magma_int_t* lda, const float* B, const magma_int_t* ldb, magma_int_t* info);
...
void lapackf77_ssysv(const char* uplo, const magma_int_t* n, const magma_int_t* nrhs, float* A, const magma_int_t* lda, magma_int_t* ipiv, float* B, const magma_int_t* ldb, float* work, const magma_int_t* lwork, magma_int_t* info);
...
#ifdef COMPLEX
void lapackf77_slacp2(const char* uplo, const magma_int_t* m, const magma_int_t* n, const float* A, const magma_int_t* lda, float* B, const magma_int_t* ldb);
#endif
...
#ifdef COMPLEX
void lapackf77_slacrm(const magma_int_t* m, const magma_int_t* n, const float* A, const magma_int_t* lda, const float* B, const magma_int_t* ldb, float* C, const magma_int_t* ldc, float* rwork);
#endif

#ifdef COMPLEX
void lapackf77_sladiv(float* ret_val, const float* x, const float* y);
#else // REAL
void lapackf77_sladiv(const float* a, const float* b, const float* c, const float* d, float* p, float* q);
#endif

void lapackf77_slasyf(const char* uplo, const magma_int_t* n, const magma_int_t* nb, magma_int_t* kb, float* A, const magma_int_t* lda, magma_int_t* ipiv, float* work, const magma_int_t* ldwork, magma_int_t* info);
...
float lapackf77_slantr(const char* norm, const char* uplo, const char* diag, const magma_int_t* m, const magma_int_t* n, const float* A, const magma_int_t* lda, float* work);

void lapackf77_slaqp2(const magma_int_t* m, const magma_int_t* n, const magma_int_t* offset, float* A, const magma_int_t* lda, magma_int_t* jpvt, float* tau, float* vn1, float* vn2, float* work);

#ifdef COMPLEX
void lapackf77_slarcm(const magma_int_t* m, const magma_int_t* n, const float* A, const magma_int_t* lda, const float* B, const magma_int_t* ldb, float* C, const magma_int_t* ldc, float* rwork);
#endif

void lapackf77_slarf(const char* side, const magma_int_t* m, const magma_int_t* n, const float* v, const magma_int_t* incv, const float* tau, float* C, const magma_int_t* ldc, float* work);
...
void lapackf77_slarft(const char* direct, const char* storev, const magma_int_t* n, const magma_int_t* k, const float* V, const magma_int_t* ldv, const float* tau, float* T, const magma_int_t* ldt);

void lapackf77_slarfx(const char* side, const magma_int_t* m, const magma_int_t* n, const float* V, const float* tau, float* C, const magma_int_t* ldc, float* work);

void lapackf77_slarnv(const magma_int_t* idist, magma_int_t* iseed, const magma_int_t* n, float* x);

void lapackf77_slartg(const float* f, const float* g, float* cs, float* sn, float* r);

void lapackf77_slascl(const char* type, const magma_int_t* kl, const magma_int_t* ku, const float* cfrom, const float* cto, const magma_int_t* m, const magma_int_t* n, float* A, const magma_int_t* lda, magma_int_t* info);
...
void lapackf77_slaswp(const magma_int_t* n, float* A, const magma_int_t* lda, const magma_int_t* k1, const magma_int_t* k2, const magma_int_t* ipiv, const magma_int_t* incx);
...
void lapackf77_slatrs(const char* uplo, const char* trans, const char* diag, const char* normin, const magma_int_t* n, const float* A, const magma_int_t* lda, float* x, float* scale, float* cnorm, magma_int_t* info);
...
void lapackf77_ssyr(const char* uplo, const magma_int_t* n, const float* alpha, const float* x, const magma_int_t* incx, float* A, const magma_int_t* lda);
...
void lapackf77_strevc3(const char* side,
    const char* howmny,
    magma_int_t* select,
    const magma_int_t* n,
    float* T,
...
void lapackf77_ssyt21(const magma_int_t* itype,
    const char* uplo,
    const magma_int_t* n,
...
void lapackf77_slatms(const magma_int_t* m, const magma_int_t* n, const char* dist, magma_int_t* iseed, const char* sym, float* d, const magma_int_t* mode, const float* cond, const float* dmax, const magma_int_t* kl, const magma_int_t* ku, const char* pack, float* A, const magma_int_t* lda, float* work, magma_int_t* info);
