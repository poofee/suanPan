/*
 ...
 @generated from sparse/include/magmasparse_z.h, normal z -> s, Wed Nov 15 00:34:29 2017
 @author Hartwig Anzt
*/
...
magma_int_t magma_swrapper(magma_sopts* zopts, magma_s_matrix* A, magma_s_matrix* x, magma_s_matrix* b, magma_queue_t queue);
...
magma_int_t magma_swrite_csrtomtx(magma_s_matrix A, const char* filename, magma_queue_t queue);
...
magma_int_t magma_svinit(magma_s_matrix* x, magma_location_t memory_location, magma_int_t num_rows, magma_int_t num_cols, float values, magma_queue_t queue);

magma_int_t magma_svinit_rand(magma_s_matrix* x, magma_location_t memory_location, magma_int_t num_rows, magma_int_t num_cols, magma_queue_t queue);

magma_int_t magma_sprint_vector(magma_s_matrix x, magma_int_t offset, magma_int_t displaylength, magma_queue_t queue);
...
magma_int_t magma_ssolverinfo_init(magma_s_solver_par* solver_par, magma_s_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_seigensolverinfo_init(magma_s_solver_par* solver_par, magma_queue_t queue);

magma_int_t magma_sprecondfree(magma_s_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_ssolverinfo_free(magma_s_solver_par* solver_par, magma_s_preconditioner* precond, magma_queue_t queue);
...
magma_int_t magma_smatrix_tril(magma_s_matrix A, magma_s_matrix* U, magma_queue_t queue);
...
magma_int_t magma_sparilut_elementsum(magma_s_matrix A, float* sum, magma_queue_t queue);
...
magma_int_t magma_sparilut_transpose(magma_s_matrix A, magma_s_matrix* B, magma_queue_t queue);
...
magma_int_t magma_sparilut_sweep(magma_s_matrix* A, magma_s_matrix* L, magma_s_matrix* U, magma_queue_t queue);
...
magma_int_t magma_smisai_blockstruct(magma_int_t n, magma_int_t bs, magma_int_t offs, magma_uplo_t uplotype, magma_s_matrix* S, magma_queue_t queue);
...
magma_int_t magma_sbfgmres(magma_s_matrix A, magma_s_matrix b, magma_s_matrix* x, magma_s_solver_par* solver_par, magma_s_preconditioner* precond_par, magma_queue_t queue);

magma_int_t magma_sidr(magma_s_matrix A, magma_s_matrix b, magma_s_matrix* x, magma_s_solver_par* solver_par, magma_queue_t queue);
...
magma_int_t magma_spidr(magma_s_matrix A, magma_s_matrix b, magma_s_matrix* x, magma_s_solver_par* solver_par, magma_s_preconditioner* precond_par, magma_queue_t queue);
...
magma_int_t magma_sbcsrlu(magma_s_matrix A, magma_s_matrix b, magma_s_matrix* x, magma_s_solver_par* solver_par, magma_queue_t queue);

magma_int_t magma_sbcsrlutrf(magma_s_matrix A, magma_s_matrix* M, magma_int_t* ipiv, magma_int_t version, magma_queue_t queue);

magma_int_t magma_sbcsrlusv(magma_s_matrix A, magma_s_matrix b, magma_s_matrix* x, magma_s_solver_par* solver_par, magma_int_t* ipiv, magma_queue_t queue);

magma_int_t magma_silucg(magma_s_matrix A, magma_s_matrix b, magma_s_matrix* x, magma_s_solver_par* solver_par, magma_queue_t queue);

magma_int_t magma_silugmres(magma_s_matrix A, magma_s_matrix b, magma_s_matrix* x, magma_s_solver_par* solver_par, magma_queue_t queue);
...
magma_int_t magma_slobpcg_res(magma_int_t num_rows, magma_int_t num_vecs, float* evalues, magmaFloat_ptr X, magmaFloat_ptr R, float* res, magma_queue_t queue);
...
*/
magma_int_t magma_slobpcg(magma_s_matrix A, magma_s_solver_par* solver_par, magma_s_preconditioner* precond_par, magma_queue_t queue);
...
magma_int_t magma_spardiso(magma_s_matrix A, magma_s_matrix b, magma_s_matrix* x, magma_s_solver_par* solver_par, magma_queue_t queue);
...
magma_int_t magma_scuilusetup(magma_s_matrix A, magma_s_preconditioner* precond, magma_queue_t queue);
...
magma_int_t magma_sapplycuilu_l(magma_s_matrix b, magma_s_matrix* x, magma_s_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_sapplycuilu_r(magma_s_matrix b, magma_s_matrix* x, magma_s_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_scuiccsetup(magma_s_matrix A, magma_s_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_sapplycuicc_l(magma_s_matrix b, magma_s_matrix* x, magma_s_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_sapplycuicc_r(magma_s_matrix b, magma_s_matrix* x, magma_s_preconditioner* precond, magma_queue_t queue);
...
magma_int_t magma_scustomspmv(magma_int_t m, magma_int_t n, float alpha, float beta, magmaFloat_ptr x, magmaFloat_ptr y, magma_queue_t queue);

magma_int_t magma_s_spmv_shift(float alpha, magma_s_matrix A, float lambda, magma_s_matrix x, float beta, magma_int_t offset, magma_int_t blocksize, magmaIndex_ptr dadd_vecs, magma_s_matrix y, magma_queue_t queue);
...
magma_int_t magma_scuspaxpy(magmaFloat_ptr alpha, magma_s_matrix A, magmaFloat_ptr beta, magma_s_matrix B, magma_s_matrix* AB, magma_queue_t queue);
...
magma_int_t magma_s_initP2P(magma_int_t* bandwidth_benchmark, magma_int_t* num_gpus, magma_queue_t queue);

magma_int_t magma_scompact(magma_int_t m, magma_int_t n, magmaFloat_ptr dA, magma_int_t ldda, float* dnorms, float tol, magma_int_t* activeMask, magma_int_t* cBlockSize, magma_queue_t queue);

magma_int_t magma_scompactActive(magma_int_t m, magma_int_t n, magmaFloat_ptr dA, magma_int_t ldda, magma_int_t* active, magma_queue_t queue);
...
magma_int_t magma_sdiagcheck_cpu(magma_s_matrix A, magma_queue_t queue);
...
magma_int_t magma_sgecsrmv_shift(magma_trans_t transA, magma_int_t m, magma_int_t n, float alpha, float lambda, magmaFloat_ptr dval, magmaIndex_ptr drowptr, magmaIndex_ptr dcolind, magmaFloat_ptr dx, float beta, magma_int_t offset, magma_int_t blocksize, magmaIndex_ptr dadd_rows, magmaFloat_ptr dy, magma_queue_t queue);
...
magma_int_t magma_sgeellmv_shift(magma_trans_t transA, magma_int_t m, magma_int_t n, magma_int_t nnz_per_row, float alpha, float lambda, magmaFloat_ptr dval, magmaIndex_ptr dcolind, magmaFloat_ptr dx, float beta, magma_int_t offset, magma_int_t blocksize, magmaIndex_ptr dadd_rows, magmaFloat_ptr dy, magma_queue_t queue);
...
magma_int_t magma_sgeelltmv_shift(magma_trans_t transA, magma_int_t m, magma_int_t n, magma_int_t nnz_per_row, float alpha, float lambda, magmaFloat_ptr dval, magmaIndex_ptr dcolind, magmaFloat_ptr dx, float beta, magma_int_t offset, magma_int_t blocksize, magmaIndex_ptr dadd_rows, magmaFloat_ptr dy, magma_queue_t queue);
...
magma_int_t magma_sgeellrtmv(magma_trans_t transA, magma_int_t m, magma_int_t n, magma_int_t nnz_per_row, float alpha, magmaFloat_ptr dval, magmaIndex_ptr dcolind, magmaIndex_ptr drowlength, magmaFloat_ptr dx, float beta, magmaFloat_ptr dy, magma_int_t num_threads, magma_int_t threads_per_row, magma_queue_t queue);
...
magma_int_t magma_smgesellpmv_blocked(magma_trans_t transA, magma_int_t m, magma_int_t n, magma_int_t num_vecs, magma_int_t blocksize, magma_int_t slices, magma_int_t alignment, float alpha, magmaFloat_ptr dval, magmaIndex_ptr dcolind, magmaIndex_ptr drowptr, magmaFloat_ptr dx, float beta, magmaFloat_ptr dy, magma_queue_t queue);
...
magma_int_t magma_sgecscsyncfreetrsm_analysis(magma_int_t m, magma_int_t nnz, magmaFloat_ptr dval, magmaIndex_ptr dcolptr, magmaIndex_ptr drowind, magmaIndex_ptr dgraphindegree, magmaIndex_ptr dgraphindegree_bak, magma_queue_t queue);

magma_int_t magma_sgecscsyncfreetrsm_solve(magma_int_t m, magma_int_t nnz, magmaFloat_ptr dval, magmaIndex_ptr dcolptr, magmaIndex_ptr drowind, magmaIndex_ptr dgraphindegree, magmaIndex_ptr dgraphindegree_bak, magmaFloat_ptr dx, magmaFloat_ptr db, magma_int_t substitution, magma_int_t rhs, magma_queue_t queue);

magma_int_t magma_smergedgs(magma_int_t n, magma_int_t ldh, magma_int_t k, magmaFloat_ptr dv, magmaFloat_ptr dr, magmaFloat_ptr dskp, magma_queue_t queue);
...
magma_int_t magma_scgmerge_spmv1(magma_s_matrix A, magmaFloat_ptr d1, magmaFloat_ptr d2, magmaFloat_ptr dd, magmaFloat_ptr dz, magmaFloat_ptr dskp, magma_queue_t queue);

magma_int_t magma_scgmerge_xrbeta(magma_int_t n, magmaFloat_ptr d1, magmaFloat_ptr d2, magmaFloat_ptr dx, magmaFloat_ptr dr, magmaFloat_ptr dd, magmaFloat_ptr dz, magmaFloat_ptr dskp, magma_queue_t queue);
...
magma_int_t magma_smdotc_shfl(magma_int_t n, magma_int_t k, magmaFloat_ptr dv, magmaFloat_ptr dr, magmaFloat_ptr dd1, magmaFloat_ptr dd2, magmaFloat_ptr dskp, magma_queue_t queue);

magma_int_t magma_smdotc(magma_int_t n, magma_int_t k, magmaFloat_ptr dv, magmaFloat_ptr dr, magmaFloat_ptr dd1, magmaFloat_ptr dd2, magmaFloat_ptr dskp, magma_queue_t queue);

magma_int_t magma_sgemvmdot_shfl(magma_int_t n, magma_int_t k, magmaFloat_ptr dv, magmaFloat_ptr dr, magmaFloat_ptr dd1, magmaFloat_ptr dd2, magmaFloat_ptr dskp, magma_queue_t queue);

magma_int_t magma_sgemvmdot(magma_int_t n, magma_int_t k, magmaFloat_ptr dv, magmaFloat_ptr dr, magmaFloat_ptr dd1, magmaFloat_ptr dd2, magmaFloat_ptr dskp, magma_queue_t queue);
...
magma_int_t magma_stestasync(magma_s_matrix A, magma_queue_t queue);
