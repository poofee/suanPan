/*
 ...
 @generated from sparse/include/magmasparse_z.h, normal z -> d, Wed Nov 15 00:34:29 2017
 @author Hartwig Anzt
*/
...
magma_int_t magma_dwrapper(magma_dopts* zopts, magma_d_matrix* A, magma_d_matrix* x, magma_d_matrix* b, magma_queue_t queue);
...
magma_int_t magma_dwrite_csrtomtx(magma_d_matrix A, const char* filename, magma_queue_t queue);
...
magma_int_t magma_dvinit(magma_d_matrix* x, magma_location_t memory_location, magma_int_t num_rows, magma_int_t num_cols, double values, magma_queue_t queue);

magma_int_t magma_dvinit_rand(magma_d_matrix* x, magma_location_t memory_location, magma_int_t num_rows, magma_int_t num_cols, magma_queue_t queue);

magma_int_t magma_dprint_vector(magma_d_matrix x, magma_int_t offset, magma_int_t displaylength, magma_queue_t queue);
...
magma_int_t magma_dsolverinfo_init(magma_d_solver_par* solver_par, magma_d_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_deigensolverinfo_init(magma_d_solver_par* solver_par, magma_queue_t queue);

magma_int_t magma_dprecondfree(magma_d_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_dsolverinfo_free(magma_d_solver_par* solver_par, magma_d_preconditioner* precond, magma_queue_t queue);
...
magma_int_t magma_dmatrix_tril(magma_d_matrix A, magma_d_matrix* U, magma_queue_t queue);
...
magma_int_t magma_dparilut_elementsum(magma_d_matrix A, double* sum, magma_queue_t queue);
...
magma_int_t magma_diluisaisetup_lower(magma_d_matrix A, magma_d_matrix S, magma_d_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_diluisaisetup_upper(magma_d_matrix A, magma_d_matrix S, magma_d_preconditioner* precond, magma_queue_t queue);
...
magma_int_t magma_dmisai_blockstruct(magma_int_t n, magma_int_t bs, magma_int_t offs, magma_uplo_t uplotype, magma_d_matrix* S, magma_queue_t queue);
...
magma_int_t magma_dbfgmres(magma_d_matrix A, magma_d_matrix b, magma_d_matrix* x, magma_d_solver_par* solver_par, magma_d_preconditioner* precond_par, magma_queue_t queue);
...
magma_int_t magma_dpidr(magma_d_matrix A, magma_d_matrix b, magma_d_matrix* x, magma_d_solver_par* solver_par, magma_d_preconditioner* precond_par, magma_queue_t queue);
...
magma_int_t magma_dbcsrlu(magma_d_matrix A, magma_d_matrix b, magma_d_matrix* x, magma_d_solver_par* solver_par, magma_queue_t queue);

magma_int_t magma_dbcsrlutrf(magma_d_matrix A, magma_d_matrix* M, magma_int_t* ipiv, magma_int_t version, magma_queue_t queue);

magma_int_t magma_dbcsrlusv(magma_d_matrix A, magma_d_matrix b, magma_d_matrix* x, magma_d_solver_par* solver_par, magma_int_t* ipiv, magma_queue_t queue);

magma_int_t magma_dilucg(magma_d_matrix A, magma_d_matrix b, magma_d_matrix* x, magma_d_solver_par* solver_par, magma_queue_t queue);

magma_int_t magma_dilugmres(magma_d_matrix A, magma_d_matrix b, magma_d_matrix* x, magma_d_solver_par* solver_par, magma_queue_t queue);
...
magma_int_t magma_dlobpcg_res(magma_int_t num_rows, magma_int_t num_vecs, double* evalues, magmaDouble_ptr X, magmaDouble_ptr R, double* res, magma_queue_t queue);
...
magma_int_t magma_dpardiso(magma_d_matrix A, magma_d_matrix b, magma_d_matrix* x, magma_d_solver_par* solver_par, magma_queue_t queue);
...
magma_int_t magma_dcuilusetup(magma_d_matrix A, magma_d_preconditioner* precond, magma_queue_t queue);
...
magma_int_t magma_dapplycuilu_l(magma_d_matrix b, magma_d_matrix* x, magma_d_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_dapplycuilu_r(magma_d_matrix b, magma_d_matrix* x, magma_d_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_dcuiccsetup(magma_d_matrix A, magma_d_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_dapplycuicc_l(magma_d_matrix b, magma_d_matrix* x, magma_d_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_dapplycuicc_r(magma_d_matrix b, magma_d_matrix* x, magma_d_preconditioner* precond, magma_queue_t queue);
...
magma_int_t magma_dcustomspmv(magma_int_t m, magma_int_t n, double alpha, double beta, magmaDouble_ptr x, magmaDouble_ptr y, magma_queue_t queue);

magma_int_t magma_d_spmv_shift(double alpha, magma_d_matrix A, double lambda, magma_d_matrix x, double beta, magma_int_t offset, magma_int_t blocksize, magmaIndex_ptr dadd_vecs, magma_d_matrix y, magma_queue_t queue);
...
magma_int_t magma_dcuspaxpy(magmaDouble_ptr alpha, magma_d_matrix A, magmaDouble_ptr beta, magma_d_matrix B, magma_d_matrix* AB, magma_queue_t queue);
...
magma_int_t magma_d_initP2P(magma_int_t* bandwidth_benchmark, magma_int_t* num_gpus, magma_queue_t queue);

magma_int_t magma_dcompact(magma_int_t m, magma_int_t n, magmaDouble_ptr dA, magma_int_t ldda, double* dnorms, double tol, magma_int_t* activeMask, magma_int_t* cBlockSize, magma_queue_t queue);

magma_int_t magma_dcompactActive(magma_int_t m, magma_int_t n, magmaDouble_ptr dA, magma_int_t ldda, magma_int_t* active, magma_queue_t queue);
...
magma_int_t magma_ddiagcheck_cpu(magma_d_matrix A, magma_queue_t queue);
...
magma_int_t magma_dgecsrmv_shift(magma_trans_t transA, magma_int_t m, magma_int_t n, double alpha, double lambda, magmaDouble_ptr dval, magmaIndex_ptr drowptr, magmaIndex_ptr dcolind, magmaDouble_ptr dx, double beta, magma_int_t offset, magma_int_t blocksize, magmaIndex_ptr dadd_rows, magmaDouble_ptr dy, magma_queue_t queue);
...
magma_int_t magma_dgeellmv_shift(magma_trans_t transA, magma_int_t m, magma_int_t n, magma_int_t nnz_per_row, double alpha, double lambda, magmaDouble_ptr dval, magmaIndex_ptr dcolind, magmaDouble_ptr dx, double beta, magma_int_t offset, magma_int_t blocksize, magmaIndex_ptr dadd_rows, magmaDouble_ptr dy, magma_queue_t queue);
...
magma_int_t magma_dgeellrtmv(magma_trans_t transA, magma_int_t m, magma_int_t n, magma_int_t nnz_per_row, double alpha, magmaDouble_ptr dval, magmaIndex_ptr dcolind, magmaIndex_ptr drowlength, magmaDouble_ptr dx, double beta, magmaDouble_ptr dy, magma_int_t num_threads, magma_int_t threads_per_row, magma_queue_t queue);
...
magma_int_t magma_dgecscsyncfreetrsm_analysis(magma_int_t m, magma_int_t nnz, magmaDouble_ptr dval, magmaIndex_ptr dcolptr, magmaIndex_ptr drowind, magmaIndex_ptr dgraphindegree, magmaIndex_ptr dgraphindegree_bak, magma_queue_t queue);

magma_int_t magma_dgecscsyncfreetrsm_solve(magma_int_t m, magma_int_t nnz, magmaDouble_ptr dval, magmaIndex_ptr dcolptr, magmaIndex_ptr drowind, magmaIndex_ptr dgraphindegree, magmaIndex_ptr dgraphindegree_bak, magmaDouble_ptr dx, magmaDouble_ptr db, magma_int_t substitution, magma_int_t rhs, magma_queue_t queue);

magma_int_t magma_dmergedgs(magma_int_t n, magma_int_t ldh, magma_int_t k, magmaDouble_ptr dv, magmaDouble_ptr dr, magmaDouble_ptr dskp, magma_queue_t queue);
...
magma_int_t magma_dcgmerge_spmv1(magma_d_matrix A, magmaDouble_ptr d1, magmaDouble_ptr d2, magmaDouble_ptr dd, magmaDouble_ptr dz, magmaDouble_ptr dskp, magma_queue_t queue);

magma_int_t magma_dcgmerge_xrbeta(magma_int_t n, magmaDouble_ptr d1, magmaDouble_ptr d2, magmaDouble_ptr dx, magmaDouble_ptr dr, magmaDouble_ptr dd, magmaDouble_ptr dz, magmaDouble_ptr dskp, magma_queue_t queue);
...
magma_int_t magma_dmdotc_shfl(magma_int_t n, magma_int_t k, magmaDouble_ptr dv, magmaDouble_ptr dr, magmaDouble_ptr dd1, magmaDouble_ptr dd2, magmaDouble_ptr dskp, magma_queue_t queue);

magma_int_t magma_dmdotc(magma_int_t n, magma_int_t k, magmaDouble_ptr dv, magmaDouble_ptr dr, magmaDouble_ptr dd1, magmaDouble_ptr dd2, magmaDouble_ptr dskp, magma_queue_t queue);

magma_int_t magma_dgemvmdot_shfl(magma_int_t n, magma_int_t k, magmaDouble_ptr dv, magmaDouble_ptr dr, magmaDouble_ptr dd1, magmaDouble_ptr dd2, magmaDouble_ptr dskp, magma_queue_t queue);

magma_int_t magma_dgemvmdot(magma_int_t n, magma_int_t k, magmaDouble_ptr dv, magmaDouble_ptr dr, magmaDouble_ptr dd1, magmaDouble_ptr dd2, magmaDouble_ptr dskp, magma_queue_t queue);
...
magma_int_t magma_dtestasync(magma_d_matrix A, magma_queue_t queue);
