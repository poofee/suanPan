...
// -----------------------------------------------------------------------------
// sparse
typedef enum { Magma_CSR = 611, Magma_ELLPACKT = 612, Magma_ELL = 613, Magma_DENSE = 614, Magma_BCSR = 615, Magma_CSC = 616, Magma_HYB = 617, Magma_COO = 618, Magma_ELLRT = 619, Magma_SPMVFUNCTION = 620, Magma_SELLP = 621, Magma_ELLD = 622, Magma_CSRLIST = 623, Magma_CSRD = 624, Magma_CSRL = 627, Magma_CSRU = 628, Magma_CSRCOO = 629, Magma_CUCSR = 630, Magma_COOLIST = 631, Magma_CSR5 = 632 } magma_storage_t;
...
typedef enum { Magma_CGSO = 561, Magma_FUSED_CGSO = 562, Magma_MGSO = 563 } magma_ortho_t;

typedef enum { Magma_CPU = 571, Magma_DEV = 572 } magma_location_t;

typedef enum { Magma_GENERAL = 581, Magma_SYMMETRIC = 582 } magma_symmetry_t;

typedef enum { Magma_ORDERED = 591, Magma_DIAGFIRST = 592, Magma_UNITY = 593, Magma_VALUE = 594 } magma_diagorder_t;

typedef enum { Magma_DCOMPLEX = 501, Magma_FCOMPLEX = 502, Magma_DOUBLE = 503, Magma_FLOAT = 504 } magma_precision;
...
typedef enum { Magma_SOLVE = 801, Magma_SETUPSOLVE = 802, Magma_APPLYSOLVE = 803, Magma_DESTROYSOLVE = 804, Magma_INFOSOLVE = 805, Magma_GENERATEPREC = 806, Magma_PRECONDLEFT = 807, Magma_PRECONDRIGHT = 808, Magma_TRANSPOSE = 809, Magma_SPMV = 810 } magma_operation_t;
