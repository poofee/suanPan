...
void lapackf77_zcgesv(const magma_int_t* n, const magma_int_t* nrhs, magmaDoubleComplex* A, const magma_int_t* lda, magma_int_t* ipiv, const magmaDoubleComplex* B, const magma_int_t* ldb, magmaDoubleComplex* X, const magma_int_t* ldx, magmaDoubleComplex* work, magmaFloatComplex* swork, double* rwork, magma_int_t* iter, magma_int_t* info);

void lapackf77_dsgesv(const magma_int_t* n, const magma_int_t* nrhs, double* A, const magma_int_t* lda, magma_int_t* ipiv, const double* B, const magma_int_t* ldb, double* X, const magma_int_t* ldx, double* work, float* swork, magma_int_t* iter, magma_int_t* info);

void lapackf77_dsterf(const magma_int_t* n, double* d, double* e, magma_int_t* info);

void lapackf77_ssterf(const magma_int_t* n, float* d, float* e, magma_int_t* info);

// precision conversion, general matrix
void lapackf77_zlag2c(const magma_int_t* m, const magma_int_t* n, const magmaDoubleComplex* A, const magma_int_t* lda, magmaFloatComplex* SA, const magma_int_t* ldsa, magma_int_t* info);

void lapackf77_clag2z(const magma_int_t* m, const magma_int_t* n, const magmaFloatComplex* SA, const magma_int_t* ldsa, magmaDoubleComplex* A, const magma_int_t* lda, magma_int_t* info);

void lapackf77_dlag2s(const magma_int_t* m, const magma_int_t* n, const double* A, const magma_int_t* lda, float* SA, const magma_int_t* ldsa, magma_int_t* info);

void lapackf77_slag2d(const magma_int_t* m, const magma_int_t* n, const float* SA, const magma_int_t* ldsa, double* A, const magma_int_t* lda, magma_int_t* info);

// precision conversion, triangular (or symmetric) matrix
void lapackf77_zlat2c(const char* uplo, const magma_int_t* n, const magmaDoubleComplex* A, const magma_int_t* lda, magmaFloatComplex* SA, const magma_int_t* ldsa, magma_int_t* info);

void lapackf77_dlat2s(const char* uplo, const magma_int_t* n, const double* A, const magma_int_t* lda, float* SA, const magma_int_t* ldsa, magma_int_t* info);
