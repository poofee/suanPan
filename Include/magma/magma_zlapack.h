...
void blasf77_zher(const char* uplo, const magma_int_t* n, const double* alpha, const magmaDoubleComplex* x, const magma_int_t* incx, magmaDoubleComplex* A, const magma_int_t* lda);
...
void blasf77_zrotg(magmaDoubleComplex* ca, const magmaDoubleComplex* cb, double* c, magmaDoubleComplex* s);

void blasf77_zrot(const magma_int_t* n, magmaDoubleComplex* x, const magma_int_t* incx, magmaDoubleComplex* y, const magma_int_t* incy, const double* c, const magmaDoubleComplex* s);

void blasf77_zdrot(const magma_int_t* n, magmaDoubleComplex* x, const magma_int_t* incx, magmaDoubleComplex* y, const magma_int_t* incy, const double* c, const double* s);
...
void lapackf77_zgbbrd(const char* vect,
    const magma_int_t* m,
    const magma_int_t* n,
...
void lapackf77_zgbsv(const magma_int_t* n, const magma_int_t* kl, const magma_int_t* ku, const magma_int_t* nrhs, magmaDoubleComplex* ab, const magma_int_t* ldab, magma_int_t* ipiv, magmaDoubleComplex* B, const magma_int_t* ldb, magma_int_t* info);
...
void lapackf77_zhetf2(const char* uplo, const magma_int_t* n, magmaDoubleComplex* A, const magma_int_t* lda, magma_int_t* ipiv, magma_int_t* info);

void lapackf77_zhetrs(const char* uplo, const magma_int_t* n, const magma_int_t* nrhs, const magmaDoubleComplex* A, const magma_int_t* lda, const magma_int_t* ipiv, magmaDoubleComplex* B, const magma_int_t* ldb, magma_int_t* info);
...
void lapackf77_zhegs2(const magma_int_t* itype, const char* uplo, const magma_int_t* n, magmaDoubleComplex* A, const magma_int_t* lda, const magmaDoubleComplex* B, const magma_int_t* ldb, magma_int_t* info);

void lapackf77_zhegst(const magma_int_t* itype, const char* uplo, const magma_int_t* n, magmaDoubleComplex* A, const magma_int_t* lda, const magmaDoubleComplex* B, const magma_int_t* ldb, magma_int_t* info);
...
void lapackf77_zhesv(const char* uplo, const magma_int_t* n, const magma_int_t* nrhs, magmaDoubleComplex* A, const magma_int_t* lda, magma_int_t* ipiv, magmaDoubleComplex* B, const magma_int_t* ldb, magmaDoubleComplex* work, const magma_int_t* lwork, magma_int_t* info);
...
#ifdef COMPLEX
void lapackf77_zlacp2(const char* uplo, const magma_int_t* m, const magma_int_t* n, const double* A, const magma_int_t* lda, magmaDoubleComplex* B, const magma_int_t* ldb);
#endif
...
#ifdef COMPLEX
void lapackf77_zlacrm(const magma_int_t* m, const magma_int_t* n, const magmaDoubleComplex* A, const magma_int_t* lda, const double* B, const magma_int_t* ldb, magmaDoubleComplex* C, const magma_int_t* ldc, double* rwork);
#endif

#ifdef COMPLEX
void lapackf77_zladiv(magmaDoubleComplex* ret_val, const magmaDoubleComplex* x, const magmaDoubleComplex* y);
#else // REAL
void lapackf77_zladiv(const double* a, const double* b, const double* c, const double* d, double* p, double* q);
#endif

void lapackf77_zlahef(const char* uplo, const magma_int_t* n, const magma_int_t* nb, magma_int_t* kb, magmaDoubleComplex* A, const magma_int_t* lda, magma_int_t* ipiv, magmaDoubleComplex* work, const magma_int_t* ldwork, magma_int_t* info);
...
double lapackf77_zlantr(const char* norm, const char* uplo, const char* diag, const magma_int_t* m, const magma_int_t* n, const magmaDoubleComplex* A, const magma_int_t* lda, double* work);

void lapackf77_zlaqp2(const magma_int_t* m, const magma_int_t* n, const magma_int_t* offset, magmaDoubleComplex* A, const magma_int_t* lda, magma_int_t* jpvt, magmaDoubleComplex* tau, double* vn1, double* vn2, magmaDoubleComplex* work);

#ifdef COMPLEX
void lapackf77_zlarcm(const magma_int_t* m, const magma_int_t* n, const double* A, const magma_int_t* lda, const magmaDoubleComplex* B, const magma_int_t* ldb, magmaDoubleComplex* C, const magma_int_t* ldc, double* rwork);
#endif

void lapackf77_zlarf(const char* side, const magma_int_t* m, const magma_int_t* n, const magmaDoubleComplex* v, const magma_int_t* incv, const magmaDoubleComplex* tau, magmaDoubleComplex* C, const magma_int_t* ldc, magmaDoubleComplex* work);
...
void lapackf77_zlarft(const char* direct, const char* storev, const magma_int_t* n, const magma_int_t* k, const magmaDoubleComplex* V, const magma_int_t* ldv, const magmaDoubleComplex* tau, magmaDoubleComplex* T, const magma_int_t* ldt);

void lapackf77_zlarfx(const char* side, const magma_int_t* m, const magma_int_t* n, const magmaDoubleComplex* V, const magmaDoubleComplex* tau, magmaDoubleComplex* C, const magma_int_t* ldc, magmaDoubleComplex* work);

void lapackf77_zlarnv(const magma_int_t* idist, magma_int_t* iseed, const magma_int_t* n, magmaDoubleComplex* x);

void lapackf77_zlartg(const magmaDoubleComplex* f, const magmaDoubleComplex* g, double* cs, magmaDoubleComplex* sn, magmaDoubleComplex* r);

void lapackf77_zlascl(const char* type, const magma_int_t* kl, const magma_int_t* ku, const double* cfrom, const double* cto, const magma_int_t* m, const magma_int_t* n, magmaDoubleComplex* A, const magma_int_t* lda, magma_int_t* info);
...
void lapackf77_zlaswp(const magma_int_t* n, magmaDoubleComplex* A, const magma_int_t* lda, const magma_int_t* k1, const magma_int_t* k2, const magma_int_t* ipiv, const magma_int_t* incx);
...
void lapackf77_zlatrs(const char* uplo, const char* trans, const char* diag, const char* normin, const magma_int_t* n, const magmaDoubleComplex* A, const magma_int_t* lda, magmaDoubleComplex* x, double* scale, double* cnorm, magma_int_t* info);
...
void lapackf77_zsyr(const char* uplo, const magma_int_t* n, const magmaDoubleComplex* alpha, const magmaDoubleComplex* x, const magma_int_t* incx, magmaDoubleComplex* A, const magma_int_t* lda);

void lapackf77_zsysv(const char* uplo, const magma_int_t* n, const magma_int_t* nrhs, magmaDoubleComplex* A, const magma_int_t* lda, magma_int_t* ipiv, magmaDoubleComplex* B, const magma_int_t* ldb, magmaDoubleComplex* work, const magma_int_t* lwork, magma_int_t* info);
...
void lapackf77_ztrevc3(const char* side,
    const char* howmny,
    magma_int_t* select,
    const magma_int_t* n,
    magmaDoubleComplex* T,
...
void lapackf77_zlatms(const magma_int_t* m, const magma_int_t* n, const char* dist, magma_int_t* iseed, const char* sym, double* d, const magma_int_t* mode, const double* cond, const double* dmax, const magma_int_t* kl, const magma_int_t* ku, const char* pack, magmaDoubleComplex* A, const magma_int_t* lda, magmaDoubleComplex* work, magma_int_t* info);
