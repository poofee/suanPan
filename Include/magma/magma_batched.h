...
void setup_pivinfo_batched(magma_int_t** pivinfo_array, magma_int_t** ipiv_array, magma_int_t m, magma_int_t nb, magma_int_t batchCount, magma_queue_t queue);

void adjust_ipiv_batched(magma_int_t** ipiv_array, magma_int_t m, magma_int_t offset, magma_int_t batchCount, magma_queue_t queue);
