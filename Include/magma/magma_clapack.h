/*
    -- MAGMA (version 2.3.0) --
       ...
       @generated from include/magma_zlapack.h, normal z -> c, Wed Nov 15 00:34:25 2017
*/
...
void blasf77_cher(const char* uplo, const magma_int_t* n, const float* alpha, const magmaFloatComplex* x, const magma_int_t* incx, magmaFloatComplex* A, const magma_int_t* lda);
...
void blasf77_crotg(magmaFloatComplex* ca, const magmaFloatComplex* cb, float* c, magmaFloatComplex* s);

void blasf77_crot(const magma_int_t* n, magmaFloatComplex* x, const magma_int_t* incx, magmaFloatComplex* y, const magma_int_t* incy, const float* c, const magmaFloatComplex* s);

void blasf77_csrot(const magma_int_t* n, magmaFloatComplex* x, const magma_int_t* incx, magmaFloatComplex* y, const magma_int_t* incy, const float* c, const float* s);
 ...
 */
#ifdef REAL
void lapackf77_sbdsdc(const char* uplo, const char* compq, const magma_int_t* n, float* d, float* e, float* U, const magma_int_t* ldu, float* VT, const magma_int_t* ldvt, float* Q, magma_int_t* IQ, float* work, magma_int_t* iwork, magma_int_t* info);
#endif
...
void lapackf77_cgbbrd(const char* vect,
    const magma_int_t* m,
    const magma_int_t* n,
...
void lapackf77_cgbsv(const magma_int_t* n, const magma_int_t* kl, const magma_int_t* ku, const magma_int_t* nrhs, magmaFloatComplex* ab, const magma_int_t* ldab, magma_int_t* ipiv, magmaFloatComplex* B, const magma_int_t* ldb, magma_int_t* info);
...
void lapackf77_chetf2(const char* uplo, const magma_int_t* n, magmaFloatComplex* A, const magma_int_t* lda, magma_int_t* ipiv, magma_int_t* info);

void lapackf77_chetrs(const char* uplo, const magma_int_t* n, const magma_int_t* nrhs, const magmaFloatComplex* A, const magma_int_t* lda, const magma_int_t* ipiv, magmaFloatComplex* B, const magma_int_t* ldb, magma_int_t* info);
...
void lapackf77_chegs2(const magma_int_t* itype, const char* uplo, const magma_int_t* n, magmaFloatComplex* A, const magma_int_t* lda, const magmaFloatComplex* B, const magma_int_t* ldb, magma_int_t* info);

void lapackf77_chegst(const magma_int_t* itype, const char* uplo, const magma_int_t* n, magmaFloatComplex* A, const magma_int_t* lda, const magmaFloatComplex* B, const magma_int_t* ldb, magma_int_t* info);
...
void lapackf77_chesv(const char* uplo, const magma_int_t* n, const magma_int_t* nrhs, magmaFloatComplex* A, const magma_int_t* lda, magma_int_t* ipiv, magmaFloatComplex* B, const magma_int_t* ldb, magmaFloatComplex* work, const magma_int_t* lwork, magma_int_t* info);
...
#ifdef COMPLEX
void lapackf77_clacp2(const char* uplo, const magma_int_t* m, const magma_int_t* n, const float* A, const magma_int_t* lda, magmaFloatComplex* B, const magma_int_t* ldb);
#endif
...
#ifdef COMPLEX
void lapackf77_clacrm(const magma_int_t* m, const magma_int_t* n, const magmaFloatComplex* A, const magma_int_t* lda, const float* B, const magma_int_t* ldb, magmaFloatComplex* C, const magma_int_t* ldc, float* rwork);
#endif

#ifdef COMPLEX
void lapackf77_cladiv(magmaFloatComplex* ret_val, const magmaFloatComplex* x, const magmaFloatComplex* y);
#else // REAL
void lapackf77_cladiv(const float* a, const float* b, const float* c, const float* d, float* p, float* q);
#endif

void lapackf77_clahef(const char* uplo, const magma_int_t* n, const magma_int_t* nb, magma_int_t* kb, magmaFloatComplex* A, const magma_int_t* lda, magma_int_t* ipiv, magmaFloatComplex* work, const magma_int_t* ldwork, magma_int_t* info);
...
void lapackf77_claqp2(const magma_int_t* m, const magma_int_t* n, const magma_int_t* offset, magmaFloatComplex* A, const magma_int_t* lda, magma_int_t* jpvt, magmaFloatComplex* tau, float* vn1, float* vn2, magmaFloatComplex* work);

#ifdef COMPLEX
void lapackf77_clarcm(const magma_int_t* m, const magma_int_t* n, const float* A, const magma_int_t* lda, const magmaFloatComplex* B, const magma_int_t* ldb, magmaFloatComplex* C, const magma_int_t* ldc, float* rwork);
#endif

void lapackf77_clarf(const char* side, const magma_int_t* m, const magma_int_t* n, const magmaFloatComplex* v, const magma_int_t* incv, const magmaFloatComplex* tau, magmaFloatComplex* C, const magma_int_t* ldc, magmaFloatComplex* work);
...
void lapackf77_clarft(const char* direct, const char* storev, const magma_int_t* n, const magma_int_t* k, const magmaFloatComplex* V, const magma_int_t* ldv, const magmaFloatComplex* tau, magmaFloatComplex* T, const magma_int_t* ldt);

void lapackf77_clarfx(const char* side, const magma_int_t* m, const magma_int_t* n, const magmaFloatComplex* V, const magmaFloatComplex* tau, magmaFloatComplex* C, const magma_int_t* ldc, magmaFloatComplex* work);

void lapackf77_clarnv(const magma_int_t* idist, magma_int_t* iseed, const magma_int_t* n, magmaFloatComplex* x);

void lapackf77_clartg(const magmaFloatComplex* f, const magmaFloatComplex* g, float* cs, magmaFloatComplex* sn, magmaFloatComplex* r);

void lapackf77_clascl(const char* type, const magma_int_t* kl, const magma_int_t* ku, const float* cfrom, const float* cto, const magma_int_t* m, const magma_int_t* n, magmaFloatComplex* A, const magma_int_t* lda, magma_int_t* info);
...
void lapackf77_claswp(const magma_int_t* n, magmaFloatComplex* A, const magma_int_t* lda, const magma_int_t* k1, const magma_int_t* k2, const magma_int_t* ipiv, const magma_int_t* incx);
...
void lapackf77_clatrs(const char* uplo, const char* trans, const char* diag, const char* normin, const magma_int_t* n, const magmaFloatComplex* A, const magma_int_t* lda, magmaFloatComplex* x, float* scale, float* cnorm, magma_int_t* info);
...
void lapackf77_csyr(const char* uplo, const magma_int_t* n, const magmaFloatComplex* alpha, const magmaFloatComplex* x, const magma_int_t* incx, magmaFloatComplex* A, const magma_int_t* lda);

void lapackf77_csysv(const char* uplo, const magma_int_t* n, const magma_int_t* nrhs, magmaFloatComplex* A, const magma_int_t* lda, magma_int_t* ipiv, magmaFloatComplex* B, const magma_int_t* ldb, magmaFloatComplex* work, const magma_int_t* lwork, magma_int_t* info);
...
void lapackf77_ctrevc3(const char* side,
    const char* howmny,
    magma_int_t* select,
    const magma_int_t* n,
    magmaFloatComplex* T,
 ...
 */
void lapackf77_sstebz(const char* range, const char* order, const magma_int_t* n, const float* vl, const float* vu, const magma_int_t* il, const magma_int_t* iu, const float* abstol, const float* d, const float* e, magma_int_t* m, magma_int_t* nsplit, float* w, magma_int_t* iblock, magma_int_t* isplit, float* work, magma_int_t* iwork, magma_int_t* info);

void lapackf77_slaln2(const magma_int_t* ltrans, const magma_int_t* na, const magma_int_t* nw, const float* smin, const float* ca, const float* a, const magma_int_t* lda, const float* d1, const float* d2, const float* b, const magma_int_t* ldb, const float* wr, const float* wi, float* x, const magma_int_t* ldx, float* scale, float* xnorm, magma_int_t* info);

float lapackf77_slamc3(const float* a, const float* b);

void lapackf77_slamrg(const magma_int_t* n1, const magma_int_t* n2, const float* a, const magma_int_t* dtrd1, const magma_int_t* dtrd2, magma_int_t* index);

float lapackf77_slapy3(const float* x, const float* y, const float* z);

void lapackf77_slaed2(magma_int_t* k, const magma_int_t* n, const magma_int_t* n1, float* d, float* q, const magma_int_t* ldq, magma_int_t* indxq, float* rho, const float* z, float* dlamda, float* w, float* q2, magma_int_t* indx, magma_int_t* indxc, magma_int_t* indxp, magma_int_t* coltyp, magma_int_t* info);

void lapackf77_slaed4(const magma_int_t* n, const magma_int_t* i, const float* d, const float* z, float* delta, const float* rho, float* dlam, magma_int_t* info);
...
void lapackf77_clatms(const magma_int_t* m, const magma_int_t* n, const char* dist, magma_int_t* iseed, const char* sym, float* d, const magma_int_t* mode, const float* cond, const float* dmax, const magma_int_t* kl, const magma_int_t* ku, const char* pack, magmaFloatComplex* A, const magma_int_t* lda, magmaFloatComplex* work, magma_int_t* info);
