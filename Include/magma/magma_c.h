/*
    -- MAGMA (version 2.3.0) --
       ...
       @generated from include/magma_z.h, normal z -> c, Wed Nov 15 00:34:25 2017
*/
...
void magma_cvrange(magma_int_t k, float* d, magma_int_t* il, magma_int_t* iu, float vl, float vu);

void magma_cirange(magma_int_t k, magma_int_t* indxq, magma_int_t* iil, magma_int_t* iiu, magma_int_t il, magma_int_t iu);
#endif
...
#ifdef REAL
// CUDA MAGMA only
magma_int_t magma_claqtrsd(magma_trans_t trans, magma_int_t n, const float* T, magma_int_t ldt, float* x, magma_int_t ldx, const float* cnorm, magma_int_t* info);
#endif
