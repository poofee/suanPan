/*
 ...
 @generated from sparse/include/magmasparse_z.h, normal z -> c, Wed Nov 15 00:34:29 2017
 @author Hartwig Anzt
*/
...
magma_int_t magma_cwrapper(magma_copts* zopts, magma_c_matrix* A, magma_c_matrix* x, magma_c_matrix* b, magma_queue_t queue);

magma_int_t magma_cparse_opts(int argc, char** argv, magma_copts* opts, int* matrices, magma_queue_t queue);

magma_int_t read_c_csr_from_binary(magma_int_t* n_row, magma_int_t* n_col, magma_int_t* nnz, magmaFloatComplex** val, magma_index_t** row, magma_index_t** col, const char* filename, magma_queue_t queue);
...
magma_int_t c_transpose_csr(magma_int_t n_rows, magma_int_t n_cols, magma_int_t nnz, magmaFloatComplex* val, magma_index_t* row, magma_index_t* col, magma_int_t* new_n_rows, magma_int_t* new_n_cols, magma_int_t* new_nnz, magmaFloatComplex** new_val, magma_index_t** new_row, magma_index_t** new_col, magma_queue_t queue);
...
magma_int_t magma_cwrite_csrtomtx(magma_c_matrix A, const char* filename, magma_queue_t queue);
...
magma_int_t magma_cvinit(magma_c_matrix* x, magma_location_t memory_location, magma_int_t num_rows, magma_int_t num_cols, magmaFloatComplex values, magma_queue_t queue);

magma_int_t magma_cvinit_rand(magma_c_matrix* x, magma_location_t memory_location, magma_int_t num_rows, magma_int_t num_cols, magma_queue_t queue);

magma_int_t magma_cprint_vector(magma_c_matrix x, magma_int_t offset, magma_int_t displaylength, magma_queue_t queue);
...
magma_int_t magma_csolverinfo_init(magma_c_solver_par* solver_par, magma_c_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_ceigensolverinfo_init(magma_c_solver_par* solver_par, magma_queue_t queue);

magma_int_t magma_cprecondfree(magma_c_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_csolverinfo_free(magma_c_solver_par* solver_par, magma_c_preconditioner* precond, magma_queue_t queue);
...
magma_int_t magma_cmisai_blockstruct(magma_int_t n, magma_int_t bs, magma_int_t offs, magma_uplo_t uplotype, magma_c_matrix* S, magma_queue_t queue);
...
magma_int_t magma_cpcg(magma_c_matrix A, magma_c_matrix b, magma_c_matrix* x, magma_c_solver_par* solver_par, magma_c_preconditioner* precond_par, magma_queue_t queue);
...
magma_int_t magma_cbfgmres(magma_c_matrix A, magma_c_matrix b, magma_c_matrix* x, magma_c_solver_par* solver_par, magma_c_preconditioner* precond_par, magma_queue_t queue);

magma_int_t magma_cidr(magma_c_matrix A, magma_c_matrix b, magma_c_matrix* x, magma_c_solver_par* solver_par, magma_queue_t queue);
...
magma_int_t magma_cpidr(magma_c_matrix A, magma_c_matrix b, magma_c_matrix* x, magma_c_solver_par* solver_par, magma_c_preconditioner* precond_par, magma_queue_t queue);
...
magma_int_t magma_cbcsrlu(magma_c_matrix A, magma_c_matrix b, magma_c_matrix* x, magma_c_solver_par* solver_par, magma_queue_t queue);

magma_int_t magma_cbcsrlutrf(magma_c_matrix A, magma_c_matrix* M, magma_int_t* ipiv, magma_int_t version, magma_queue_t queue);

magma_int_t magma_cbcsrlusv(magma_c_matrix A, magma_c_matrix b, magma_c_matrix* x, magma_c_solver_par* solver_par, magma_int_t* ipiv, magma_queue_t queue);

magma_int_t magma_cilucg(magma_c_matrix A, magma_c_matrix b, magma_c_matrix* x, magma_c_solver_par* solver_par, magma_queue_t queue);

magma_int_t magma_cilugmres(magma_c_matrix A, magma_c_matrix b, magma_c_matrix* x, magma_c_solver_par* solver_par, magma_queue_t queue);
...
magma_int_t magma_clobpcg_res(magma_int_t num_rows, magma_int_t num_vecs, float* evalues, magmaFloatComplex_ptr X, magmaFloatComplex_ptr R, float* res, magma_queue_t queue);
...
magma_int_t magma_cpardiso(magma_c_matrix A, magma_c_matrix b, magma_c_matrix* x, magma_c_solver_par* solver_par, magma_queue_t queue);
...
magma_int_t magma_ccuilusetup(magma_c_matrix A, magma_c_preconditioner* precond, magma_queue_t queue);
...
magma_int_t magma_capplycuilu_l(magma_c_matrix b, magma_c_matrix* x, magma_c_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_capplycuilu_r(magma_c_matrix b, magma_c_matrix* x, magma_c_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_ccuiccsetup(magma_c_matrix A, magma_c_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_capplycuicc_l(magma_c_matrix b, magma_c_matrix* x, magma_c_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_capplycuicc_r(magma_c_matrix b, magma_c_matrix* x, magma_c_preconditioner* precond, magma_queue_t queue);
...
magma_int_t magma_ccumiccsetup(magma_c_matrix A, magma_c_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_ccumicgeneratesolverinfo(magma_c_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_capplycumicc_l(magma_c_matrix b, magma_c_matrix* x, magma_c_preconditioner* precond, magma_queue_t queue);

magma_int_t magma_capplycumicc_r(magma_c_matrix b, magma_c_matrix* x, magma_c_preconditioner* precond, magma_queue_t queue);
...
magma_int_t magma_ccustomspmv(magma_int_t m, magma_int_t n, magmaFloatComplex alpha, magmaFloatComplex beta, magmaFloatComplex_ptr x, magmaFloatComplex_ptr y, magma_queue_t queue);

magma_int_t magma_c_spmv_shift(magmaFloatComplex alpha, magma_c_matrix A, magmaFloatComplex lambda, magma_c_matrix x, magmaFloatComplex beta, magma_int_t offset, magma_int_t blocksize, magmaIndex_ptr dadd_vecs, magma_c_matrix y, magma_queue_t queue);
...
magma_int_t magma_ccuspaxpy(magmaFloatComplex_ptr alpha, magma_c_matrix A, magmaFloatComplex_ptr beta, magma_c_matrix B, magma_c_matrix* AB, magma_queue_t queue);
...
magma_int_t magma_c_initP2P(magma_int_t* bandwidth_benchmark, magma_int_t* num_gpus, magma_queue_t queue);

magma_int_t magma_ccompact(magma_int_t m, magma_int_t n, magmaFloatComplex_ptr dA, magma_int_t ldda, float* dnorms, float tol, magma_int_t* activeMask, magma_int_t* cBlockSize, magma_queue_t queue);

magma_int_t magma_ccompactActive(magma_int_t m, magma_int_t n, magmaFloatComplex_ptr dA, magma_int_t ldda, magma_int_t* active, magma_queue_t queue);
...
magma_int_t magma_cdiagcheck_cpu(magma_c_matrix A, magma_queue_t queue);
...
magma_int_t magma_cgecsrmv_shift(magma_trans_t transA, magma_int_t m, magma_int_t n, magmaFloatComplex alpha, magmaFloatComplex lambda, magmaFloatComplex_ptr dval, magmaIndex_ptr drowptr, magmaIndex_ptr dcolind, magmaFloatComplex_ptr dx, magmaFloatComplex beta, magma_int_t offset, magma_int_t blocksize, magmaIndex_ptr dadd_rows, magmaFloatComplex_ptr dy, magma_queue_t queue);
...
magma_int_t magma_cgeellmv_shift(magma_trans_t transA, magma_int_t m, magma_int_t n, magma_int_t nnz_per_row, magmaFloatComplex alpha, magmaFloatComplex lambda, magmaFloatComplex_ptr dval, magmaIndex_ptr dcolind, magmaFloatComplex_ptr dx, magmaFloatComplex beta, magma_int_t offset, magma_int_t blocksize, magmaIndex_ptr dadd_rows, magmaFloatComplex_ptr dy, magma_queue_t queue);
...
magma_int_t magma_cgeelltmv_shift(magma_trans_t transA, magma_int_t m, magma_int_t n, magma_int_t nnz_per_row, magmaFloatComplex alpha, magmaFloatComplex lambda, magmaFloatComplex_ptr dval, magmaIndex_ptr dcolind, magmaFloatComplex_ptr dx, magmaFloatComplex beta, magma_int_t offset, magma_int_t blocksize, magmaIndex_ptr dadd_rows, magmaFloatComplex_ptr dy, magma_queue_t queue);
...
magma_int_t magma_cgecscsyncfreetrsm_analysis(magma_int_t m, magma_int_t nnz, magmaFloatComplex_ptr dval, magmaIndex_ptr dcolptr, magmaIndex_ptr drowind, magmaIndex_ptr dgraphindegree, magmaIndex_ptr dgraphindegree_bak, magma_queue_t queue);

magma_int_t magma_cgecscsyncfreetrsm_solve(magma_int_t m, magma_int_t nnz, magmaFloatComplex_ptr dval, magmaIndex_ptr dcolptr, magmaIndex_ptr drowind, magmaIndex_ptr dgraphindegree, magmaIndex_ptr dgraphindegree_bak, magmaFloatComplex_ptr dx, magmaFloatComplex_ptr db, magma_int_t substitution, magma_int_t rhs, magma_queue_t queue);

magma_int_t magma_cmergedgs(magma_int_t n, magma_int_t ldh, magma_int_t k, magmaFloatComplex_ptr dv, magmaFloatComplex_ptr dr, magmaFloatComplex_ptr dskp, magma_queue_t queue);
...
magma_int_t magma_ccgmerge_spmv1(magma_c_matrix A, magmaFloatComplex_ptr d1, magmaFloatComplex_ptr d2, magmaFloatComplex_ptr dd, magmaFloatComplex_ptr dz, magmaFloatComplex_ptr dskp, magma_queue_t queue);

magma_int_t magma_ccgmerge_xrbeta(magma_int_t n, magmaFloatComplex_ptr d1, magmaFloatComplex_ptr d2, magmaFloatComplex_ptr dx, magmaFloatComplex_ptr dr, magmaFloatComplex_ptr dd, magmaFloatComplex_ptr dz, magmaFloatComplex_ptr dskp, magma_queue_t queue);
...
magma_int_t magma_cmdotc_shfl(magma_int_t n, magma_int_t k, magmaFloatComplex_ptr dv, magmaFloatComplex_ptr dr, magmaFloatComplex_ptr dd1, magmaFloatComplex_ptr dd2, magmaFloatComplex_ptr dskp, magma_queue_t queue);

magma_int_t magma_cmdotc(magma_int_t n, magma_int_t k, magmaFloatComplex_ptr dv, magmaFloatComplex_ptr dr, magmaFloatComplex_ptr dd1, magmaFloatComplex_ptr dd2, magmaFloatComplex_ptr dskp, magma_queue_t queue);

magma_int_t magma_cgemvmdot_shfl(magma_int_t n, magma_int_t k, magmaFloatComplex_ptr dv, magmaFloatComplex_ptr dr, magmaFloatComplex_ptr dd1, magmaFloatComplex_ptr dd2, magmaFloatComplex_ptr dskp, magma_queue_t queue);

magma_int_t magma_cgemvmdot(magma_int_t n, magma_int_t k, magmaFloatComplex_ptr dv, magmaFloatComplex_ptr dr, magmaFloatComplex_ptr dd1, magmaFloatComplex_ptr dd2, magmaFloatComplex_ptr dskp, magma_queue_t queue);
...
magma_int_t magma_ctestasync(magma_c_matrix A, magma_queue_t queue);
