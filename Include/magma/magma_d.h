/*
    -- MAGMA (version 2.3.0) --
       ...
       @generated from include/magma_z.h, normal z -> d, Wed Nov 15 00:34:25 2017
*/
...
// CUDA MAGMA only
magma_int_t magma_dsyevr(magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, double* A, magma_int_t lda, double vl, double vu, magma_int_t il, magma_int_t iu, double abstol, magma_int_t* mout, double* w, double* Z, magma_int_t ldz, magma_int_t* isuppz, double* work, magma_int_t lwork, double* rwork, magma_int_t lrwork, magma_int_t* iwork, magma_int_t liwork, magma_int_t* info);

// CUDA MAGMA only
magma_int_t magma_dsyevr_gpu(magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, magmaDouble_ptr dA, magma_int_t ldda, double vl, double vu, magma_int_t il, magma_int_t iu, double abstol, magma_int_t* mout, double* w, magmaDouble_ptr dZ, magma_int_t lddz, magma_int_t* isuppz, double* wA, magma_int_t ldwa, double* wZ, magma_int_t ldwz, double* work, magma_int_t lwork, double* rwork, magma_int_t lrwork, magma_int_t* iwork, magma_int_t liwork, magma_int_t* info);

// CUDA MAGMA only
magma_int_t magma_dsyevx(magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, double* A, magma_int_t lda, double vl, double vu, magma_int_t il, magma_int_t iu, double abstol, magma_int_t* mout, double* w, double* Z, magma_int_t ldz, double* work, magma_int_t lwork, double* rwork, magma_int_t* iwork, magma_int_t* ifail, magma_int_t* info);

// CUDA MAGMA only
magma_int_t magma_dsyevx_gpu(magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, magmaDouble_ptr dA, magma_int_t ldda, double vl, double vu, magma_int_t il, magma_int_t iu, double abstol, magma_int_t* mout, double* w, magmaDouble_ptr dZ, magma_int_t lddz, double* wA, magma_int_t ldwa, double* wZ, magma_int_t ldwz, double* work, magma_int_t lwork, double* rwork, magma_int_t* iwork, magma_int_t* ifail, magma_int_t* info);
#endif // COMPLEX
...
// no real [sd] precisions available
// CUDA MAGMA only
magma_int_t magma_dsygvr(magma_int_t itype, magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, double* A, magma_int_t lda, double* B, magma_int_t ldb, double vl, double vu, magma_int_t il, magma_int_t iu, double abstol, magma_int_t* mout, double* w, double* Z, magma_int_t ldz, magma_int_t* isuppz, double* work, magma_int_t lwork, double* rwork, magma_int_t lrwork, magma_int_t* iwork, magma_int_t liwork, magma_int_t* info);

// no real [sd] precisions available
// CUDA MAGMA only
magma_int_t magma_dsygvx(magma_int_t itype, magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, double* A, magma_int_t lda, double* B, magma_int_t ldb, double vl, double vu, magma_int_t il, magma_int_t iu, double abstol, magma_int_t* mout, double* w, double* Z, magma_int_t ldz, double* work, magma_int_t lwork, double* rwork, magma_int_t* iwork, magma_int_t* ifail, magma_int_t* info);
#endif
...
magma_int_t magma_dlasyf_gpu(magma_uplo_t uplo, magma_int_t n, magma_int_t nb, magma_int_t* kb, double* hA, magma_int_t lda, magmaDouble_ptr dA, magma_int_t ldda, magma_int_t* ipiv, magmaDouble_ptr dW, magma_int_t lddw, magma_queue_t queues[], magma_event_t event[], magma_int_t* info);
...
#ifdef COMPLEX
// CUDA MAGMA only
magma_int_t magma_dlatrsd(magma_uplo_t uplo, magma_trans_t trans, magma_diag_t diag, magma_bool_t normin, magma_int_t n, const double* A, magma_int_t lda, double lambda, double* x, double* scale, double* cnorm, magma_int_t* info);
#endif
