/*
    -- MAGMA (version 2.3.0) --
       ...
       @generated from include/magma_z.h, normal z -> s, Wed Nov 15 00:34:25 2017
*/
...
// CUDA MAGMA only
magma_int_t magma_ssyevr(magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, float* A, magma_int_t lda, float vl, float vu, magma_int_t il, magma_int_t iu, float abstol, magma_int_t* mout, float* w, float* Z, magma_int_t ldz, magma_int_t* isuppz, float* work, magma_int_t lwork, float* rwork, magma_int_t lrwork, magma_int_t* iwork, magma_int_t liwork, magma_int_t* info);

// CUDA MAGMA only
magma_int_t magma_ssyevr_gpu(magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, magmaFloat_ptr dA, magma_int_t ldda, float vl, float vu, magma_int_t il, magma_int_t iu, float abstol, magma_int_t* mout, float* w, magmaFloat_ptr dZ, magma_int_t lddz, magma_int_t* isuppz, float* wA, magma_int_t ldwa, float* wZ, magma_int_t ldwz, float* work, magma_int_t lwork, float* rwork, magma_int_t lrwork, magma_int_t* iwork, magma_int_t liwork, magma_int_t* info);

// CUDA MAGMA only
magma_int_t magma_ssyevx(magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, float* A, magma_int_t lda, float vl, float vu, magma_int_t il, magma_int_t iu, float abstol, magma_int_t* mout, float* w, float* Z, magma_int_t ldz, float* work, magma_int_t lwork, float* rwork, magma_int_t* iwork, magma_int_t* ifail, magma_int_t* info);

// CUDA MAGMA only
magma_int_t magma_ssyevx_gpu(magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, magmaFloat_ptr dA, magma_int_t ldda, float vl, float vu, magma_int_t il, magma_int_t iu, float abstol, magma_int_t* mout, float* w, magmaFloat_ptr dZ, magma_int_t lddz, float* wA, magma_int_t ldwa, float* wZ, magma_int_t ldwz, float* work, magma_int_t lwork, float* rwork, magma_int_t* iwork, magma_int_t* ifail, magma_int_t* info);
#endif // COMPLEX
...
// no real [sd] precisions available
// CUDA MAGMA only
magma_int_t magma_ssygvr(magma_int_t itype, magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, float* A, magma_int_t lda, float* B, magma_int_t ldb, float vl, float vu, magma_int_t il, magma_int_t iu, float abstol, magma_int_t* mout, float* w, float* Z, magma_int_t ldz, magma_int_t* isuppz, float* work, magma_int_t lwork, float* rwork, magma_int_t lrwork, magma_int_t* iwork, magma_int_t liwork, magma_int_t* info);

// no real [sd] precisions available
// CUDA MAGMA only
magma_int_t magma_ssygvx(magma_int_t itype, magma_vec_t jobz, magma_range_t range, magma_uplo_t uplo, magma_int_t n, float* A, magma_int_t lda, float* B, magma_int_t ldb, float vl, float vu, magma_int_t il, magma_int_t iu, float abstol, magma_int_t* mout, float* w, float* Z, magma_int_t ldz, float* work, magma_int_t lwork, float* rwork, magma_int_t* iwork, magma_int_t* ifail, magma_int_t* info);
#endif
...
magma_int_t magma_slasyf_gpu(magma_uplo_t uplo, magma_int_t n, magma_int_t nb, magma_int_t* kb, float* hA, magma_int_t lda, magmaFloat_ptr dA, magma_int_t ldda, magma_int_t* ipiv, magmaFloat_ptr dW, magma_int_t lddw, magma_queue_t queues[], magma_event_t event[], magma_int_t* info);
...
#ifdef COMPLEX
// CUDA MAGMA only
magma_int_t magma_slatrsd(magma_uplo_t uplo, magma_trans_t trans, magma_diag_t diag, magma_bool_t normin, magma_int_t n, const float* A, magma_int_t lda, float lambda, float* x, float* scale, float* cnorm, magma_int_t* info);
#endif
