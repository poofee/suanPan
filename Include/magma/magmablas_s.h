/*
    -- MAGMA (version 2.3.0) --
       ...
       @generated from include/magmablas_z.h, normal z -> s, Wed Nov 15 00:34:25 2017
*/
 ...
 */
void magmablas_sprbt(magma_int_t n, magmaFloat_ptr dA, magma_int_t ldda, magmaFloat_ptr du, magmaFloat_ptr dv, magma_queue_t queue);

void magmablas_sprbt_mv(magma_int_t n, magmaFloat_ptr dv, magmaFloat_ptr db, magma_queue_t queue);

void magmablas_sprbt_mtv(magma_int_t n, magmaFloat_ptr du, magmaFloat_ptr db, magma_queue_t queue);

/*
 * Multi-GPU copy functions
 */
void magma_sgetmatrix_1D_col_bcyclic(magma_int_t ngpu, magma_int_t m, magma_int_t n, magma_int_t nb, magmaFloat_const_ptr const dA[], magma_int_t ldda, float* hA, magma_int_t lda, magma_queue_t queue[]);

void magma_ssetmatrix_1D_col_bcyclic(magma_int_t ngpu, magma_int_t m, magma_int_t n, magma_int_t nb, const float* hA, magma_int_t lda, magmaFloat_ptr dA[], magma_int_t ldda, magma_queue_t queue[]);

void magma_sgetmatrix_1D_row_bcyclic(magma_int_t ngpu, magma_int_t m, magma_int_t n, magma_int_t nb, magmaFloat_const_ptr const dA[], magma_int_t ldda, float* hA, magma_int_t lda, magma_queue_t queue[]);

void magma_ssetmatrix_1D_row_bcyclic(magma_int_t ngpu, magma_int_t m, magma_int_t n, magma_int_t nb, const float* hA, magma_int_t lda, magmaFloat_ptr dA[], magma_int_t ldda, magma_queue_t queue[]);
...
void magmablas_slacpy_conj(magma_int_t n, magmaFloat_ptr dA1, magma_int_t lda1, magmaFloat_ptr dA2, magma_int_t lda2, magma_queue_t queue);
...
void magmablas_slaswp_sym(magma_int_t n, magmaFloat_ptr dA, magma_int_t ldda, magma_int_t k1, magma_int_t k2, const magma_int_t* ipiv, magma_int_t inci, magma_queue_t queue);
...
void magma_slarfbx_gpu(magma_int_t m, magma_int_t k, magmaFloat_ptr V, magma_int_t ldv, magmaFloat_ptr dT, magma_int_t ldt, magmaFloat_ptr c, magmaFloat_ptr dwork, magma_queue_t queue);

void magma_slarfg_gpu(magma_int_t n, magmaFloat_ptr dx0, magmaFloat_ptr dx, magmaFloat_ptr dtau, magmaFloat_ptr dxnorm, magmaFloat_ptr dAkk, magma_queue_t queue);

void magma_slarfgtx_gpu(magma_int_t n, magmaFloat_ptr dx0, magmaFloat_ptr dx, magmaFloat_ptr dtau, magmaFloat_ptr dxnorm, magmaFloat_ptr dA, magma_int_t iter, magmaFloat_ptr V, magma_int_t ldv, magmaFloat_ptr T, magma_int_t ldt, magmaFloat_ptr dwork, magma_queue_t queue);

void magma_slarfgx_gpu(magma_int_t n, magmaFloat_ptr dx0, magmaFloat_ptr dx, magmaFloat_ptr dtau, magmaFloat_ptr dxnorm, magmaFloat_ptr dA, magma_int_t iter, magma_queue_t queue);

void magma_slarfx_gpu(magma_int_t m, magma_int_t n, magmaFloat_ptr v, magmaFloat_ptr tau, magmaFloat_ptr C, magma_int_t ldc, magmaFloat_ptr xnorm, magmaFloat_ptr dT, magma_int_t iter, magmaFloat_ptr work, magma_queue_t queue);

/*
 * Level 1 BLAS (alphabetical order)
 */
void magmablas_saxpycp(magma_int_t m, magmaFloat_ptr dr, magmaFloat_ptr dx, magmaFloat_const_ptr db, magma_queue_t queue);
...
void magmablas_snrm2_adjust(magma_int_t k, magmaFloat_ptr dxnorm, magmaFloat_ptr dc, magma_queue_t queue);
...
void magmablas_snrm2_cols(magma_int_t m, magma_int_t n, magmaFloat_ptr dA, magma_int_t ldda, magmaFloat_ptr dxnorm, magma_queue_t queue);

void magmablas_snrm2_row_check_adjust(magma_int_t k, float tol, magmaFloat_ptr dxnorm, magmaFloat_ptr dxnorm2, magmaFloat_ptr dC, magma_int_t lddc, magmaFloat_ptr dlsticc, magma_queue_t queue);
 ...
 */
void magmablas_sgemm(magma_trans_t transA, magma_trans_t transB, magma_int_t m, magma_int_t n, magma_int_t k, float alpha, magmaFloat_const_ptr dA, magma_int_t ldda, magmaFloat_const_ptr dB, magma_int_t lddb, float beta, magmaFloat_ptr dC, magma_int_t lddc, magma_queue_t queue);
...
void magmablas_ssyr2k(magma_uplo_t uplo, magma_trans_t trans, magma_int_t n, magma_int_t k, float alpha, magmaFloat_const_ptr dA, magma_int_t ldda, magmaFloat_const_ptr dB, magma_int_t lddb, float beta, magmaFloat_ptr dC, magma_int_t lddc, magma_queue_t queue);

void magmablas_ssyr2k(magma_uplo_t uplo, magma_trans_t trans, magma_int_t n, magma_int_t k, float alpha, magmaFloat_const_ptr dA, magma_int_t ldda, magmaFloat_const_ptr dB, magma_int_t lddb, float beta, magmaFloat_ptr dC, magma_int_t lddc, magma_queue_t queue);

void magmablas_ssyrk(magma_uplo_t uplo, magma_trans_t trans, magma_int_t n, magma_int_t k, float alpha, magmaFloat_const_ptr dA, magma_int_t ldda, float beta, magmaFloat_ptr dC, magma_int_t lddc, magma_queue_t queue);
...
#define magma_ssetvector(n, hx_src, incx, dy_dst, incy, queue) magma_ssetvector_internal(n, hx_src, incx, dy_dst, incy, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_getvector() for float arrays.
/// @ingroup magma_getvector
#define magma_sgetvector(n, dx_src, incx, hy_dst, incy, queue) magma_sgetvector_internal(n, dx_src, incx, hy_dst, incy, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_copyvector() for float arrays.
/// @ingroup magma_copyvector
#define magma_scopyvector(n, dx_src, incx, dy_dst, incy, queue) magma_scopyvector_internal(n, dx_src, incx, dy_dst, incy, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_setvector_async() for float arrays.
/// @ingroup magma_setvector
#define magma_ssetvector_async(n, hx_src, incx, dy_dst, incy, queue) magma_ssetvector_async_internal(n, hx_src, incx, dy_dst, incy, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_getvector_async() for float arrays.
/// @ingroup magma_getvector
#define magma_sgetvector_async(n, dx_src, incx, hy_dst, incy, queue) magma_sgetvector_async_internal(n, dx_src, incx, hy_dst, incy, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_copyvector_async() for float arrays.
/// @ingroup magma_copyvector
#define magma_scopyvector_async(n, dx_src, incx, dy_dst, incy, queue) magma_scopyvector_async_internal(n, dx_src, incx, dy_dst, incy, queue, __func__, __FILE__, __LINE__)

static inline void magma_ssetvector_internal(magma_int_t n, float const* hx_src, magma_int_t incx, magmaFloat_ptr dy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_setvector_internal(n, sizeof(float), hx_src, incx, dy_dst, incy, queue, func, file, line); }

static inline void magma_sgetvector_internal(magma_int_t n, magmaFloat_const_ptr dx_src, magma_int_t incx, float* hy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_getvector_internal(n, sizeof(float), dx_src, incx, hy_dst, incy, queue, func, file, line); }

static inline void magma_scopyvector_internal(magma_int_t n, magmaFloat_const_ptr dx_src, magma_int_t incx, magmaFloat_ptr dy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_copyvector_internal(n, sizeof(float), dx_src, incx, dy_dst, incy, queue, func, file, line); }

static inline void magma_ssetvector_async_internal(magma_int_t n, float const* hx_src, magma_int_t incx, magmaFloat_ptr dy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_setvector_async_internal(n, sizeof(float), hx_src, incx, dy_dst, incy, queue, func, file, line); }

static inline void magma_sgetvector_async_internal(magma_int_t n, magmaFloat_const_ptr dx_src, magma_int_t incx, float* hy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_getvector_async_internal(n, sizeof(float), dx_src, incx, hy_dst, incy, queue, func, file, line); }

static inline void magma_scopyvector_async_internal(magma_int_t n, magmaFloat_const_ptr dx_src, magma_int_t incx, magmaFloat_ptr dy_dst, magma_int_t incy, magma_queue_t queue, const char* func, const char* file, int line) { magma_copyvector_async_internal(n, sizeof(float), dx_src, incx, dy_dst, incy, queue, func, file, line); }
...
#define magma_ssetmatrix(m, n, hA_src, lda, dB_dst, lddb, queue) magma_ssetmatrix_internal(m, n, hA_src, lda, dB_dst, lddb, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_getmatrix() for float arrays.
/// @ingroup magma_getmatrix
#define magma_sgetmatrix(m, n, dA_src, ldda, hB_dst, ldb, queue) magma_sgetmatrix_internal(m, n, dA_src, ldda, hB_dst, ldb, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_copymatrix() for float arrays.
/// @ingroup magma_copymatrix
#define magma_scopymatrix(m, n, dA_src, ldda, dB_dst, lddb, queue) magma_scopymatrix_internal(m, n, dA_src, ldda, dB_dst, lddb, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_setmatrix_async() for float arrays.
/// @ingroup magma_setmatrix
#define magma_ssetmatrix_async(m, n, hA_src, lda, dB_dst, lddb, queue) magma_ssetmatrix_async_internal(m, n, hA_src, lda, dB_dst, lddb, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_getmatrix_async() for float arrays.
/// @ingroup magma_getmatrix
#define magma_sgetmatrix_async(m, n, dA_src, ldda, hB_dst, ldb, queue) magma_sgetmatrix_async_internal(m, n, dA_src, ldda, hB_dst, ldb, queue, __func__, __FILE__, __LINE__)

/// Type-safe version of magma_copymatrix_async() for float arrays.
/// @ingroup magma_copymatrix
#define magma_scopymatrix_async(m, n, dA_src, ldda, dB_dst, lddb, queue) magma_scopymatrix_async_internal(m, n, dA_src, ldda, dB_dst, lddb, queue, __func__, __FILE__, __LINE__)

static inline void magma_ssetmatrix_internal(magma_int_t m, magma_int_t n, float const* hA_src, magma_int_t lda, magmaFloat_ptr dB_dst, magma_int_t lddb, magma_queue_t queue, const char* func, const char* file, int line) { magma_setmatrix_internal(m, n, sizeof(float), hA_src, lda, dB_dst, lddb, queue, func, file, line); }

static inline void magma_sgetmatrix_internal(magma_int_t m, magma_int_t n, magmaFloat_const_ptr dA_src, magma_int_t ldda, float* hB_dst, magma_int_t ldb, magma_queue_t queue, const char* func, const char* file, int line) { magma_getmatrix_internal(m, n, sizeof(float), dA_src, ldda, hB_dst, ldb, queue, func, file, line); }

static inline void magma_scopymatrix_internal(magma_int_t m, magma_int_t n, magmaFloat_const_ptr dA_src, magma_int_t ldda, magmaFloat_ptr dB_dst, magma_int_t lddb, magma_queue_t queue, const char* func, const char* file, int line) { magma_copymatrix_internal(m, n, sizeof(float), dA_src, ldda, dB_dst, lddb, queue, func, file, line); }

static inline void magma_ssetmatrix_async_internal(magma_int_t m, magma_int_t n, float const* hA_src, magma_int_t lda, magmaFloat_ptr dB_dst, magma_int_t lddb, magma_queue_t queue, const char* func, const char* file, int line) { magma_setmatrix_async_internal(m, n, sizeof(float), hA_src, lda, dB_dst, lddb, queue, func, file, line); }

static inline void magma_sgetmatrix_async_internal(magma_int_t m, magma_int_t n, magmaFloat_const_ptr dA_src, magma_int_t ldda, float* hB_dst, magma_int_t ldb, magma_queue_t queue, const char* func, const char* file, int line) { magma_getmatrix_async_internal(m, n, sizeof(float), dA_src, ldda, hB_dst, ldb, queue, func, file, line); }

static inline void magma_scopymatrix_async_internal(magma_int_t m, magma_int_t n, magmaFloat_const_ptr dA_src, magma_int_t ldda, magmaFloat_ptr dB_dst, magma_int_t lddb, magma_queue_t queue, const char* func, const char* file, int line) { magma_copymatrix_async_internal(m, n, sizeof(float), dA_src, ldda, dB_dst, lddb, queue, func, file, line); }
...
magma_int_t magma_isamin(magma_int_t n, magmaFloat_const_ptr dx, magma_int_t incx, magma_queue_t queue);
...
void magma_srot(magma_int_t n, magmaFloat_ptr dx, magma_int_t incx, magmaFloat_ptr dy, magma_int_t incy, float dc, float ds, magma_queue_t queue);
...
#ifdef REAL
void magma_srotm(magma_int_t n, magmaFloat_ptr dx, magma_int_t incx, magmaFloat_ptr dy, magma_int_t incy, magmaFloat_const_ptr param, magma_queue_t queue);

void magma_srotmg(magmaFloat_ptr d1, magmaFloat_ptr d2, magmaFloat_ptr x1, magmaFloat_const_ptr y1, magmaFloat_ptr param, magma_queue_t queue);
#endif
