...
template <typename eT> inline bool is_band(uword& out_KL, uword& out_KU, const Mat<eT>& A, const uword N_min) {
...
template <typename eT> inline bool is_band_lower(uword& out_KD, const Mat<eT>& A, const uword N_min) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline bool is_band_upper(uword& out_KD, const Mat<eT>& A, const uword N_min) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline void compress(Mat<eT>& AB, const Mat<eT>& A, const uword KL, const uword KU, const bool use_offset) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline void uncompress(Mat<eT>& A, const Mat<eT>& AB, const uword KL, const uword KU, const bool use_offset) {
    arma_extra_debug_sigprint();
