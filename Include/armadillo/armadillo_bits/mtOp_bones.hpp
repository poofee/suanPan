...
public:
    ...
    static const bool is_row = (
        ...
        T1::is_row && (is_op_mixed_elem<op_type>::value || is_same_type<op_type, op_clamp>::value || is_same_type<op_type, op_hist>::value || is_same_type<op_type, op_real>::value || is_same_type<op_type, op_imag>::value || is_same_type<op_type, op_abs>::value || is_same_type<op_type, op_arg>::value));

    static const bool is_col = (
                                   // operations which always result in a column vector
                                   (is_same_type<op_type, op_find>::value) || (is_same_type<op_type, op_find_simple>::value) || (is_same_type<op_type, op_find_unique>::value) || (is_same_type<op_type, op_sort_index>::value) || (is_same_type<op_type, op_stable_sort_index>::value) || (is_same_type<op_type, op_roots>::value)) ||
        (
            // operations which result in a column vector if the input is a column vector
            T1::is_col && (is_op_mixed_elem<op_type>::value || is_same_type<op_type, op_clamp>::value || is_same_type<op_type, op_hist>::value || is_same_type<op_type, op_real>::value || is_same_type<op_type, op_imag>::value || is_same_type<op_type, op_abs>::value || is_same_type<op_type, op_arg>::value));
