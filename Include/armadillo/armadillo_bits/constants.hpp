...
class Datum_helper {
public:
    template <typename eT> static typename arma_real_only<eT>::result nan(typename arma_real_only<eT>::result* junk = 0) {
        arma_ignore(junk);
    ...
    template <typename eT> static typename arma_cx_only<eT>::result nan(typename arma_cx_only<eT>::result* junk = 0) {
        arma_ignore(junk);
    ...
    template <typename eT> static typename arma_integral_only<eT>::result nan(typename arma_integral_only<eT>::result* junk = 0) {
        arma_ignore(junk);

        return eT(0);
    }

    template <typename eT> static typename arma_real_only<eT>::result inf(typename arma_real_only<eT>::result* junk = 0) {
        arma_ignore(junk);
    ...
    template <typename eT> static typename arma_cx_only<eT>::result inf(typename arma_cx_only<eT>::result* junk = 0) {
        arma_ignore(junk);
    ...
    template <typename eT> static typename arma_integral_only<eT>::result inf(typename arma_integral_only<eT>::result* junk = 0) {
        arma_ignore(junk);
...
template <typename eT> static arma_inline arma_hot typename arma_real_only<eT>::result most_neg(typename arma_real_only<eT>::result* junk = 0) {
    arma_ignore(junk);
...
template <typename eT> static arma_inline arma_hot typename arma_integral_only<eT>::result most_neg(typename arma_integral_only<eT>::result* junk = 0) {
    arma_ignore(junk);

    return std::numeric_limits<eT>::min();
}

template <typename eT> static arma_inline arma_hot typename arma_real_only<eT>::result most_pos(typename arma_real_only<eT>::result* junk = 0) {
    arma_ignore(junk);
...
template <typename eT> static arma_inline arma_hot typename arma_integral_only<eT>::result most_pos(typename arma_integral_only<eT>::result* junk = 0) {
    arma_ignore(junk);
