...
template <typename eT> inline arma_warn_unused typename SpMat<eT>::const_iterator SpMat<eT>::const_iterator::operator++(int) {
...
template <typename eT> inline arma_warn_unused typename SpMat<eT>::iterator SpMat<eT>::iterator::operator++(int) {
 ...
 */
template <typename eT> inline arma_warn_unused typename SpMat<eT>::const_row_iterator SpMat<eT>::const_row_iterator::operator++(int) {
...
template <typename eT> inline arma_warn_unused typename SpMat<eT>::row_iterator SpMat<eT>::row_iterator::operator++(int) {
