...
public:
    ...
    static const bool is_row = (
                                   ...
                                   T1::is_row && (is_same_type<op_type, op_sort_default>::yes || is_same_type<op_type, op_shift_default>::yes || is_same_type<op_type, op_shuffle_default>::yes || is_same_type<op_type, op_cumsum_default>::yes || is_same_type<op_type, op_cumprod_default>::yes || is_same_type<op_type, op_flipud>::yes || is_same_type<op_type, op_fliplr>::yes || is_same_type<op_type, op_reverse_vec>::yes || is_same_type<op_type, op_unique>::yes || is_same_type<op_type, op_diff_default>::yes || is_same_type<op_type, op_normalise_vec>::yes || is_same_type<op_type, op_chi2rnd>::yes)) ||
        (
    ...
    static const bool is_col = (
        ...
        (
            ...
            T1::is_col && (is_same_type<op_type, op_sort_default>::yes || is_same_type<op_type, op_shift_default>::yes || is_same_type<op_type, op_shuffle_default>::yes || is_same_type<op_type, op_cumsum_default>::yes || is_same_type<op_type, op_cumprod_default>::yes || is_same_type<op_type, op_flipud>::yes || is_same_type<op_type, op_fliplr>::yes || is_same_type<op_type, op_reverse_vec>::yes || is_same_type<op_type, op_unique>::yes || is_same_type<op_type, op_diff_default>::yes || is_same_type<op_type, op_normalise_vec>::yes || is_same_type<op_type, op_chi2rnd>::yes)) ||
        (
