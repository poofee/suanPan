...
template <typename T1, typename T2> inline void glue_min::apply(Mat<typename T1::elem_type>& out, const Glue<T1, T2, glue_min>& X) {
...
template <typename eT, typename T1, typename T2> inline void glue_min::apply(Mat<eT>& out, const Proxy<T1>& PA, const Proxy<T2>& PB) {
    arma_extra_debug_sigprint();
...
template <typename T, typename T1, typename T2> inline void glue_min::apply(Mat<std::complex<T>>& out, const Proxy<T1>& PA, const Proxy<T2>& PB) {
    arma_extra_debug_sigprint();
...
template <typename T1, typename T2> inline void glue_min::apply(Cube<typename T1::elem_type>& out, const GlueCube<T1, T2, glue_min>& X) {
    arma_extra_debug_sigprint();
...
template <typename eT, typename T1, typename T2> inline void glue_min::apply(Cube<eT>& out, const ProxyCube<T1>& PA, const ProxyCube<T2>& PB) {
    arma_extra_debug_sigprint();
...
template <typename T, typename T1, typename T2> inline void glue_min::apply(Cube<std::complex<T>>& out, const ProxyCube<T1>& PA, const ProxyCube<T2>& PB) {
    arma_extra_debug_sigprint();
