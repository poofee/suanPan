...
inline void arma_rng_cxx11::set_seed(const arma_rng_cxx11::seed_type val) {
    engine.seed(val);
...
arma_inline int arma_rng_cxx11::randi_val() { return i_distr(engine); }

arma_inline double arma_rng_cxx11::randu_val() { return u_distr(engine); }
...
template <typename eT> inline void arma_rng_cxx11::randg_fill_simple(eT* mem, const uword N, const double a, const double b) {
