...
template <typename T1, typename T2> inline typename T1::elem_type as_scalar_redirect<2>::apply(const Glue<T1, T2, glue_times>& X) {
    ...
    if(do_partial_unwrap) {
        ...
        arma_debug_check((PA.get_n_rows() != 1) || (PB.get_n_cols() != 1) || (PA.get_n_cols() != PB.get_n_rows()), "as_scalar(): incompatible dimensions");
...
template <typename T1, typename T2, typename T3> inline typename T1::elem_type as_scalar_redirect<3>::apply(const Glue<Glue<T1, T2, glue_times>, T3, glue_times>& X) {
    ...
    if(tmp2_do_diagmat == false) {
        ...
        arma_debug_check((A_n_rows != 1) || (C_n_cols != 1) || (A_n_cols != B_n_rows) || (B_n_cols != C_n_rows), "as_scalar(): incompatible dimensions");
...
template <typename T1> arma_warn_unused inline typename T1::elem_type as_scalar(const Gen<T1, gen_randu>& X) {
    arma_extra_debug_sigprint();
...
template <typename T1> arma_warn_unused inline typename T1::elem_type as_scalar(const Gen<T1, gen_randn>& X) {
    arma_extra_debug_sigprint();
