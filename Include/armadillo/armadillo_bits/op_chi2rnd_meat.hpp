...
template <typename T1> inline void op_chi2rnd::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_chi2rnd>& in) {
...
template <typename T1> inline void op_chi2rnd::apply_noalias(Mat<typename T1::elem_type>& out, const Proxy<T1>& P) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline void op_chi2rnd::fill_constant_df(Mat<eT>& out, const eT df) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline op_chi2rnd_varying_df<eT>::~op_chi2rnd_varying_df() { arma_extra_debug_sigprint(); }
...
template <typename eT> inline eT op_chi2rnd_varying_df<eT>::operator()(const eT df) {
    arma_extra_debug_sigprint();
