...
template <typename T1> inline void op_wishrnd::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_wishrnd>& expr) {
...
template <typename T1> inline bool op_wishrnd::apply_direct(Mat<typename T1::elem_type>& out, const Base<typename T1::elem_type, T1>& X, const typename T1::elem_type df, const uword mode) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline bool op_wishrnd::apply_noalias_mode1(Mat<eT>& out, const Mat<eT>& S, const eT df) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline bool op_wishrnd::apply_noalias_mode2(Mat<eT>& out, const Mat<eT>& D, const eT df) {
    arma_extra_debug_sigprint();
...
template <typename T1> inline void op_iwishrnd::apply(Mat<typename T1::elem_type>& out, const Op<T1, op_iwishrnd>& expr) {
    arma_extra_debug_sigprint();
...
template <typename T1> inline bool op_iwishrnd::apply_direct(Mat<typename T1::elem_type>& out, const Base<typename T1::elem_type, T1>& X, const typename T1::elem_type df, const uword mode) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline bool op_iwishrnd::apply_noalias_mode1(Mat<eT>& out, const Mat<eT>& T, const eT df) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline bool op_iwishrnd::apply_noalias_mode2(Mat<eT>& out, const Mat<eT>& Dinv, const eT df) {
    arma_extra_debug_sigprint();
