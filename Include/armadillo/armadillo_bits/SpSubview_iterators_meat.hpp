...
template <typename eT>
inline SpSubview<eT>::iterator_base::iterator_base(const SpSubview<eT>& in_M, const uword in_col, const uword in_pos)
    : M(&in_M)
    , internal_col(in_col)
    , internal_pos(in_pos) {
    // Nothing to do.
...
template <typename eT> arma_inline eT SpSubview<eT>::const_iterator::operator*() const { return iterator_base::M->m.values[iterator_base::internal_pos + skip_pos]; }

template <typename eT> inline arma_hot typename SpSubview<eT>::const_iterator& SpSubview<eT>::const_iterator::operator++() {
    const uword aux_col = iterator_base::M->aux_col1;
    const uword aux_row = iterator_base::M->aux_row1;
    const uword ln_rows = iterator_base::M->n_rows;
    const uword ln_cols = iterator_base::M->n_cols;
...
template <typename eT> inline arma_warn_unused typename SpSubview<eT>::const_iterator SpSubview<eT>::const_iterator::operator++(int) {
...
template <typename eT> inline arma_hot bool SpSubview<eT>::const_iterator::operator==(const const_iterator& rhs) const { return (rhs.row() == (*this).row()) && (rhs.col() == iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_iterator::operator!=(const const_iterator& rhs) const { return (rhs.row() != (*this).row()) || (rhs.col() != iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_iterator::operator==(const typename SpMat<eT>::const_iterator& rhs) const { return (rhs.row() == (*this).row()) && (rhs.col() == iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_iterator::operator!=(const typename SpMat<eT>::const_iterator& rhs) const { return (rhs.row() != (*this).row()) || (rhs.col() != iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_iterator::operator==(const const_row_iterator& rhs) const { return (rhs.row() == (*this).row()) && (rhs.col() == iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_iterator::operator!=(const const_row_iterator& rhs) const { return (rhs.row() != (*this).row()) || (rhs.col() != iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_iterator::operator==(const typename SpMat<eT>::const_row_iterator& rhs) const { return (rhs.row() == (*this).row()) && (rhs.col() == iterator_base::internal_col); }
...
template <typename eT> inline arma_hot SpValProxy<SpSubview<eT>> SpSubview<eT>::iterator::operator*() { return SpValProxy<SpSubview<eT>>(const_iterator::row(), iterator_base::col(), access::rw(*iterator_base::M), &(access::rw(iterator_base::M->m.values[iterator_base::internal_pos + const_iterator::skip_pos]))); }

template <typename eT> inline arma_hot typename SpSubview<eT>::iterator& SpSubview<eT>::iterator::operator++() {
    const_iterator::operator++();
    return *this;
}

template <typename eT> inline arma_warn_unused typename SpSubview<eT>::iterator SpSubview<eT>::iterator::operator++(int) {
...
template <typename eT> inline arma_hot typename SpSubview<eT>::const_row_iterator& SpSubview<eT>::const_row_iterator::operator++() {
...
template <typename eT> inline arma_warn_unused typename SpSubview<eT>::const_row_iterator SpSubview<eT>::const_row_iterator::operator++(int) {
...
template <typename eT> inline arma_hot bool SpSubview<eT>::const_row_iterator::operator==(const const_iterator& rhs) const { return (rhs.row() == row()) && (rhs.col() == iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_row_iterator::operator!=(const const_iterator& rhs) const { return (rhs.row() != row()) || (rhs.col() != iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_row_iterator::operator==(const typename SpMat<eT>::const_iterator& rhs) const { return (rhs.row() == row()) && (rhs.col() == iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_row_iterator::operator!=(const typename SpMat<eT>::const_iterator& rhs) const { return (rhs.row() != row()) || (rhs.col() != iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_row_iterator::operator==(const const_row_iterator& rhs) const { return (rhs.row() == row()) && (rhs.col() == iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_row_iterator::operator!=(const const_row_iterator& rhs) const { return (rhs.row() != row()) || (rhs.col() != iterator_base::internal_col); }

template <typename eT> inline arma_hot bool SpSubview<eT>::const_row_iterator::operator==(const typename SpMat<eT>::const_row_iterator& rhs) const { return (rhs.row() == row()) && (rhs.col() == iterator_base::internal_col); }
...
template <typename eT> inline arma_hot SpValProxy<SpSubview<eT>> SpSubview<eT>::row_iterator::operator*() { return SpValProxy<SpSubview<eT>>(const_row_iterator::internal_row, iterator_base::internal_col, access::rw(*iterator_base::M), &access::rw(iterator_base::M->m.values[const_row_iterator::actual_pos])); }

template <typename eT> inline arma_hot typename SpSubview<eT>::row_iterator& SpSubview<eT>::row_iterator::operator++() {
    const_row_iterator::operator++();
    return *this;
}

template <typename eT> inline arma_warn_unused typename SpSubview<eT>::row_iterator SpSubview<eT>::row_iterator::operator++(int) {
