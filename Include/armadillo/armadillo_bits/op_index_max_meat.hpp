...
template <typename T1> inline void op_index_max::apply(Cube<uword>& out, const mtOpCube<uword, T1, op_index_max>& in) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline void op_index_max::apply_noalias(Cube<uword>& out, const Cube<eT>& X, const uword dim, const typename arma_not_cx<eT>::result* junk) {
    arma_extra_debug_sigprint();
    arma_ignore(junk);
...
template <typename eT> inline void op_index_max::apply_noalias(Cube<uword>& out, const Cube<eT>& X, const uword dim, const typename arma_cx_only<eT>::result* junk) {
    arma_extra_debug_sigprint();
    arma_ignore(junk);
