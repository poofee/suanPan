...
template <typename T1, typename T2> inline void spglue_times_misc::sparse_times_dense(Mat<typename T1::elem_type>& out, const T1& x, const T2& y) {
    arma_extra_debug_sigprint();
...
template <typename T1, typename T2> inline void spglue_times_misc::dense_times_sparse(Mat<typename T1::elem_type>& out, const T1& x, const T2& y) {
    arma_extra_debug_sigprint();
