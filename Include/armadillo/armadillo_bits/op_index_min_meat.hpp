...
template <typename T1> inline void op_index_min::apply(Mat<uword>& out, const mtOp<uword, T1, op_index_min>& in) {
...
template <typename eT> inline void op_index_min::apply_noalias(Mat<uword>& out, const Mat<eT>& X, const uword dim) {
    arma_extra_debug_sigprint();
...
template <typename T1> inline void op_index_min::apply(Cube<uword>& out, const mtOpCube<uword, T1, op_index_min>& in) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline void op_index_min::apply_noalias(Cube<uword>& out, const Cube<eT>& X, const uword dim, const typename arma_not_cx<eT>::result* junk) {
    arma_extra_debug_sigprint();
    arma_ignore(junk);
...
template <typename eT> inline void op_index_min::apply_noalias(Cube<uword>& out, const Cube<eT>& X, const uword dim, const typename arma_cx_only<eT>::result* junk) {
    arma_extra_debug_sigprint();
    arma_ignore(junk);
...
template <typename T1> inline void op_index_min::apply(Mat<uword>& out, const SpBase<typename T1::elem_type, T1>& expr, const uword dim) {
    arma_extra_debug_sigprint();
