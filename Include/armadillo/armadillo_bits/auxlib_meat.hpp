...
template <typename eT> inline eT auxlib::det_tinymat(const Mat<eT>& X, const uword N) {
    ...
    case 4: {
        ...
        const eT val = Xm[pos<0, 3>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 0>::n4] - Xm[pos<0, 2>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 0>::n4] - Xm[pos<0, 3>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 0>::n4] + Xm[pos<0, 1>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 0>::n4] + Xm[pos<0, 2>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 0>::n4] - Xm[pos<0, 1>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 0>::n4] - Xm[pos<0, 3>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 1>::n4] + Xm[pos<0, 2>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 1>::n4] + Xm[pos<0, 3>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 1>::n4] - Xm[pos<0, 0>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 1>::n4] - Xm[pos<0, 2>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 1>::n4] + Xm[pos<0, 0>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 1>::n4] +
            Xm[pos<0, 3>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 2>::n4] - Xm[pos<0, 1>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 2>::n4] - Xm[pos<0, 3>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 2>::n4] + Xm[pos<0, 0>::n4] * Xm[pos<1, 3>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 2>::n4] + Xm[pos<0, 1>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 2>::n4] - Xm[pos<0, 0>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 3>::n4] * Xm[pos<3, 2>::n4] - Xm[pos<0, 2>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 3>::n4] + Xm[pos<0, 1>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 0>::n4] * Xm[pos<3, 3>::n4] + Xm[pos<0, 2>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 3>::n4] - Xm[pos<0, 0>::n4] * Xm[pos<1, 2>::n4] * Xm[pos<2, 1>::n4] * Xm[pos<3, 3>::n4] - Xm[pos<0, 1>::n4] * Xm[pos<1, 0>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 3>::n4] + Xm[pos<0, 0>::n4] * Xm[pos<1, 1>::n4] * Xm[pos<2, 2>::n4] * Xm[pos<3, 3>::n4];
        ...
        if(vecs_on) {
            for(uword j = 0; j < X.n_rows; ++j) {
                if((j < (X.n_rows - 1)) && (vals_mem[j] == std::conj(vals_mem[j + 1]))) {
                    ...
                    for(uword i = 0; i < X.n_rows; ++i) { vecs.at(i, j) = std::complex<T>(tmp.at(i, j), T(0)); }
                }
            }
        }
        ...
        if(vecs_on) {
            for(uword j = 0; j < A.n_rows; ++j) {
                if((j < (A.n_rows - 1)) && (vals_mem[j] == std::conj(vals_mem[j + 1]))) {
                    ...
                    for(uword i = 0; i < A.n_rows; ++i) { vecs.at(i, j) = std::complex<T>(tmp.at(i, j), T(0)); }
                }
            }
        }
...
template <typename eT> inline bool auxlib::chol(Mat<eT>& X, const uword layout) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline bool auxlib::chol_band(Mat<eT>& X, const uword KD, const uword layout) {
    arma_extra_debug_sigprint();

    return auxlib::chol_band_common(X, KD, layout);
}

template <typename T> inline bool auxlib::chol_band(Mat<std::complex<T>>& X, const uword KD, const uword layout) {
    arma_extra_debug_sigprint();
...
template <typename eT> inline bool auxlib::chol_band_common(Mat<eT>& X, const uword KD, const uword layout) {
    arma_extra_debug_sigprint();
...
template <typename T1> inline bool auxlib::solve_square_refine(Mat<typename T1::pod_type>& out, typename T1::pod_type& out_rcond, Mat<typename T1::pod_type>& A, const Base<typename T1::pod_type, T1>& B_expr, const bool equilibrate) {
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::gesvx(&fact, &trans, &n, &nrhs, A.memptr(), &lda, AF.memptr(), &ldaf, IPIV.memptr(), &equed, R.memptr(), C.memptr(), B.memptr(), &ldb, out.memptr(), &ldx, &rcond, FERR.memptr(), BERR.memptr(), WORK.memptr(), IWORK.memptr(), &info);
...
template <typename T1> inline bool auxlib::solve_square_refine(Mat<std::complex<typename T1::pod_type>>& out, typename T1::pod_type& out_rcond, Mat<std::complex<typename T1::pod_type>>& A, const Base<std::complex<typename T1::pod_type>, T1>& B_expr, const bool equilibrate) {
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::cx_gesvx(&fact, &trans, &n, &nrhs, A.memptr(), &lda, AF.memptr(), &ldaf, IPIV.memptr(), &equed, R.memptr(), C.memptr(), B.memptr(), &ldb, out.memptr(), &ldx, &rcond, FERR.memptr(), BERR.memptr(), WORK.memptr(), RWORK.memptr(), &info);
...
template <typename T1> inline bool auxlib::solve_approx_svd(Mat<std::complex<typename T1::pod_type>>& out, Mat<std::complex<typename T1::pod_type>>& A, const Base<std::complex<typename T1::pod_type>, T1>& B_expr) {
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        blas_int lrwork = (m >= n) ? blas_int(10) * n + blas_int(2) * n * smlsiz + blas_int(8) * n * nlvl + blas_int(3) * smlsiz * nrhs + (std::max)((smlsiz_p1) * (smlsiz_p1), n * (blas_int(1) + nrhs) + blas_int(2) * nrhs) : blas_int(10) * m + blas_int(2) * m * smlsiz + blas_int(8) * m * nlvl + blas_int(3) * smlsiz * nrhs + (std::max)((smlsiz_p1) * (smlsiz_p1), n * (blas_int(1) + nrhs) + blas_int(2) * nrhs);
...
template <typename T1> inline bool auxlib::solve_band_fast(Mat<typename T1::pod_type>& out, Mat<typename T1::pod_type>& A, const uword KL, const uword KU, const Base<typename T1::pod_type, T1>& B_expr) {
    arma_extra_debug_sigprint();
...
template <typename T1> inline bool auxlib::solve_band_fast(Mat<std::complex<typename T1::pod_type>>& out, Mat<std::complex<typename T1::pod_type>>& A, const uword KL, const uword KU, const Base<std::complex<typename T1::pod_type>, T1>& B_expr) {
    arma_extra_debug_sigprint();
...
template <typename T1> inline bool auxlib::solve_band_fast_common(Mat<typename T1::elem_type>& out, const Mat<typename T1::elem_type>& A, const uword KL, const uword KU, const Base<typename T1::elem_type, T1>& B_expr) {
    arma_extra_debug_sigprint();
...
template <typename T1> inline bool auxlib::solve_band_refine(Mat<typename T1::pod_type>& out, typename T1::pod_type& out_rcond, Mat<typename T1::pod_type>& A, const uword KL, const uword KU, const Base<typename T1::pod_type, T1>& B_expr, const bool equilibrate) {
    arma_extra_debug_sigprint();
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::gbsvx(&fact, &trans, &n, &kl, &ku, &nrhs, AB.memptr(), &ldab, AFB.memptr(), &ldafb, IPIV.memptr(), &equed, R.memptr(), C.memptr(), B.memptr(), &ldb, out.memptr(), &ldx, &rcond, FERR.memptr(), BERR.memptr(), WORK.memptr(), IWORK.memptr(), &info);
...
template <typename T1> inline bool auxlib::solve_band_refine(Mat<std::complex<typename T1::pod_type>>& out, typename T1::pod_type& out_rcond, Mat<std::complex<typename T1::pod_type>>& A, const uword KL, const uword KU, const Base<std::complex<typename T1::pod_type>, T1>& B_expr, const bool equilibrate) {
    arma_extra_debug_sigprint();
...
#elif defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::cx_gbsvx(&fact, &trans, &n, &kl, &ku, &nrhs, AB.memptr(), &ldab, AFB.memptr(), &ldafb, IPIV.memptr(), &equed, R.memptr(), C.memptr(), B.memptr(), &ldb, out.memptr(), &ldx, &rcond, FERR.memptr(), BERR.memptr(), WORK.memptr(), RWORK.memptr(), &info);
...
template <typename T, typename T1, typename T2> inline bool auxlib::qz(Mat<T>& A, Mat<T>& B, Mat<T>& vsl, Mat<T>& vsr, const Base<T, T1>& X_expr, const Base<T, T2>& Y_expr, const char mode) {
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::gges(&jobvsl, &jobvsr, &eigsort, selctg, &N, A.memptr(), &N, B.memptr(), &N, &sdim, alphar.memptr(), alphai.memptr(), beta.memptr(), vsl.memptr(), &N, vsr.memptr(), &N, work.memptr(), &lwork, bwork.memptr(), &info);
...
template <typename T, typename T1, typename T2> inline bool auxlib::qz(Mat<std::complex<T>>& A, Mat<std::complex<T>>& B, Mat<std::complex<T>>& vsl, Mat<std::complex<T>>& vsr, const Base<std::complex<T>, T1>& X_expr, const Base<std::complex<T>, T2>& Y_expr, const char mode) {
...
#if defined(ARMA_USE_LAPACK)
    {
        ...
        lapack::cx_gges(&jobvsl, &jobvsr, &eigsort, selctg, &N, A.memptr(), &N, B.memptr(), &N, &sdim, alpha.memptr(), beta.memptr(), vsl.memptr(), &N, vsr.memptr(), &N, work.memptr(), &lwork, rwork.memptr(), bwork.memptr(), &info);
...
template <typename T1> inline bool auxlib::crippled_lapack(const Base<typename T1::elem_type, T1>&) {
#if defined(ARMA_CRIPPLED_LAPACK)
    {
