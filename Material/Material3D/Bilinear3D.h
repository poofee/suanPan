...
/**
 * @class Bilinear3D
 * @brief The Bilinear3D class defines a bilinear hardening material with mixed hardening (isotropic and kinematic) based on J2 plasticity rule.
 * @author tlc
 * @date 08/08/2017
 * @version 0.1.0
 * @file Bilinear3D.h
...
public:
    explicit Bilinear3D(unsigned = 0, /**< tag */
