...
/**
 * @class Material2D
 * @brief The Material2D class defines a isotropic elastic material for
 * plane stress and
...
public:
    ...
    explicit Material2D(unsigned = 0, unsigned = MT_MATERIAL3D, const PlaneType& PT = PlaneType::S, double = 0.);
    virtual ~Material2D();
};
